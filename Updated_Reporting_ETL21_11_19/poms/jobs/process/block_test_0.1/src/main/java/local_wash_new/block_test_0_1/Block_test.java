...
package local_wash_new.block_test_0_1;
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_Block_test = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_Block_test = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_WASH_NEW_Block_test.length) {
				if(length < 1024 && commonByteArray_LOCAL_WASH_NEW_Block_test.length == 0) {
   					commonByteArray_LOCAL_WASH_NEW_Block_test = new byte[1024];
				} else {
   					commonByteArray_LOCAL_WASH_NEW_Block_test = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_WASH_NEW_Block_test, 0, length);
			strReturn = new String(commonByteArray_LOCAL_WASH_NEW_Block_test, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_WASH_NEW_Block_test) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[XJYkspOWsoJ1QlpgY6sbUzzm6B17hpNe0W834E9TNKMZxN5Q]");
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[Re5pYkUfG5XLbgHV4Ce2ijzrMVCugrjcmEJaeLPMM0V1cG4o]");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[S9g+C82MM3nLoV7VIpVnBFyNmpGkAe/Z62zv257FcQqvdYPO]");
...
java.sql.Connection conn_tMysqlOutput_2 = null;
	...
	final String decryptedPassword_tMysqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[KiYsquKO9m7bF3JD430TX6frDiOgyDGEV3cjS23+ZVxDChiv]");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[TJAL03N0JjdRFn1sRdxSIzL9ECkPo/HmSrtI+ltxje0sfjGI]");
...
java.sql.Connection conn_tMysqlOutput_3 = null;
	...
	final String decryptedPassword_tMysqlOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[CQ+qoorHYNsObOyeARdYgcYpx9CmUiG3kf0PNytOivxdU62n]");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[2vNHUwG/0Khhz3dDzh8i3ZppvPitRvSCkgsUQlv9RfYfyajr]");
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[jx3IoPciD/Iiz/sIymBs13ZJFQc0Ayi2pKwF9XNdBrOietHb]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Block_test.class.getClassLoader().getResourceAsStream("local_wash_new/block_test_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     165142 characters generated by Talend Open Studio for Data Integration 
 *     on the 21 November, 2019 1:39:19 PM IST
 ************************************************************************************************/