...
package local_wash_new.etl_process_0_1;
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.reporting_etl_job_0_2.Reporting_ETL_Job childJob_tRunJob_2 = new local_wash_new.reporting_etl_job_0_2.Reporting_ETL_Job();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.wa_mk_etl_job_0_3.WA_MK_ETL_JOB childJob_tRunJob_3 = new local_wash_new.wa_mk_etl_job_0_3.WA_MK_ETL_JOB();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.rejections_daily_etl_0_1.Rejections_daily_etl childJob_tRunJob_1 = new local_wash_new.rejections_daily_etl_0_1.Rejections_daily_etl();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.rejections_daily_etl_0_1.Rejections_daily_etl childJob_tRunJob_4 = new local_wash_new.rejections_daily_etl_0_1.Rejections_daily_etl();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = etl_process.class.getClassLoader()
					.getResourceAsStream("local_wash_new/etl_process_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 47340 characters generated by Talend Open Studio for Data Integration on the
 * 21 November, 2019 1:39:25 PM IST
 ************************************************************************************************/