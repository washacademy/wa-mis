...
package local_wash_new.operator_dimension_test_0_2;
...
public class Operator_dimension_test implements TalendJob {
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_Operator_dimension_test = new byte[0];
		static byte[] commonByteArray_LOCAL_WASH_NEW_Operator_dimension_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_WASH_NEW_Operator_dimension_test.length) {
					if (length < 1024 && commonByteArray_LOCAL_WASH_NEW_Operator_dimension_test.length == 0) {
						commonByteArray_LOCAL_WASH_NEW_Operator_dimension_test = new byte[1024];
					} else {
						commonByteArray_LOCAL_WASH_NEW_Operator_dimension_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_WASH_NEW_Operator_dimension_test, 0, length);
				strReturn = new String(commonByteArray_LOCAL_WASH_NEW_Operator_dimension_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_WASH_NEW_Operator_dimension_test) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[ycAcX3bXoJErKxCD8E4eOQ2JsoEjKnvGadlay6dKOX96RKb9]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Operator_dimension_test.class.getClassLoader().getResourceAsStream(
					"local_wash_new/operator_dimension_test_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 55227 characters generated by Talend Open Studio for Data Integration on the
 * 19 November, 2019 8:43:47 PM IST
 ************************************************************************************************/