...
package local_wash_new.rejections_daily_etl_0_1;
...
/**
 * Job: Rejections_daily_etl Purpose: Rejections_daily_etl<br>
 * Description: Rejections_daily_etl <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class Rejections_daily_etl implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Rejections_daily_etl";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Rejections_daily_etl.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Rejections_daily_etl.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(java.util.Calendar.getInstance().getTime()));
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		local_wash_new.swc_rejection_records_0_1.SWC_Rejection_Records childJob_tRunJob_1 = new local_wash_new.swc_rejection_records_0_1.SWC_Rejection_Records();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Rejections_daily_etl Rejections_daily_etlClass = new Rejections_daily_etl();

        int exitCode = Rejections_daily_etlClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Rejections_daily_etl.class.getClassLoader().getResourceAsStream("local_wash_new/rejections_daily_etl_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Rejections_daily_etl.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Rejections_daily_etl");
        }
...
/************************************************************************************************
 *     57445 characters generated by Talend Open Studio for Data Integration 
