...
package local_wash_new.state_circle_0_1;
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_state_circle = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_state_circle = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_WASH_NEW_state_circle.length) {
				if(length < 1024 && commonByteArray_LOCAL_WASH_NEW_state_circle.length == 0) {
   					commonByteArray_LOCAL_WASH_NEW_state_circle = new byte[1024];
				} else {
   					commonByteArray_LOCAL_WASH_NEW_state_circle = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_WASH_NEW_state_circle, 0, length);
			strReturn = new String(commonByteArray_LOCAL_WASH_NEW_state_circle, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_WASH_NEW_state_circle) {
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[cZHtWYt6wEz1xP4i0Tm5lQEVaIMtBXHNxqJbnAd17mRLSZsX]");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[anDUBPdtM/1COlpOkekkMFi36E3X8qw7i2l4EnhYn1bhKWOL]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = state_circle.class.getClassLoader().getResourceAsStream("local_wash_new/state_circle_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     84798 characters generated by Talend Open Studio for Data Integration 
