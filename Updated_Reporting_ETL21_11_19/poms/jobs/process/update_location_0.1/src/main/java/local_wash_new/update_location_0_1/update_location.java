...
package local_wash_new.update_location_0_1;
...
/**
 * Job: update_location Purpose: etl for front line worker<br>
 * Description: etl for front line worker <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status DEV
 */
public class update_location implements TalendJob {
...
public String getMotech_db_Server(){
	...
	private final String jobName = "update_location";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				update_location.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(update_location.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_update_location = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_update_location = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_WASH_NEW_update_location.length) {
				if(length < 1024 && commonByteArray_LOCAL_WASH_NEW_update_location.length == 0) {
   					commonByteArray_LOCAL_WASH_NEW_update_location = new byte[1024];
				} else {
   					commonByteArray_LOCAL_WASH_NEW_update_location = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_WASH_NEW_update_location, 0, length);
			strReturn = new String(commonByteArray_LOCAL_WASH_NEW_update_location, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_WASH_NEW_update_location) {
...
java.sql.Connection conn_tMysqlOutput_3 = null;
	...
	final String decryptedPassword_tMysqlOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[dnb2oGs3QNX3tkQsN3RdHwKT0NCu9J/YC2BTEUVXo2wDKeo2]");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[sKXznYOw7nRNCQuK3KFmiMcRD9UiRzpxKiaL/Rgqc4neA+BM]");
		    ...
		    String dbquery_tMysqlInput_4 = "select f.id,f.swc_id, s.id as 'state_id',\nd.district_id as 'district_id',\ncase when f.panchayat_id is null then null el"
+"se t.id end as 'panchayat_id',\ncase when f.block_id is null then null else b.block_id end as 'block_id'\nfrom swachchagra"
+"hi f\nleft join dim_state s on s.id = f.state_id\nleft join dim_district d on d.district_id = f.district_id\nleft join dim_"
+"panchayat t on t.id = f.panchayat_id\nleft join dim_block b on b.block_id = f.block_id";
            ...
            row5.swc_id = rs_tMysqlInput_4.getLong(2);
            if(rs_tMysqlInput_4.wasNull()){
                    row5.swc_id = null;
            }
		                    }
            ...
            row5.state_id = rs_tMysqlInput_4.getInt(3);
            if(rs_tMysqlInput_4.wasNull()){
                    row5.state_id = null;
            }
		                    }
            ...
            row5.district_id = rs_tMysqlInput_4.getInt(4);
            if(rs_tMysqlInput_4.wasNull()){
                    row5.district_id = null;
            }
		                    }
            ...
            row5.panchayat_id = rs_tMysqlInput_4.getInt(5);
            if(rs_tMysqlInput_4.wasNull()){
                    row5.panchayat_id = null;
            }
		                    }
            ...
            row5.block_id = rs_tMysqlInput_4.getInt(6);
            if(rs_tMysqlInput_4.wasNull()){
                    row5.block_id = null;
            }
		                    }
...
location_update_tmp.id = row5.id ;
...
} else {pstmt_tMysqlOutput_3.setInt(5, location_update.block_id);
}
 ...
 */
    ...
    public static void main(String[] args){
        final update_location update_locationClass = new update_location();

        int exitCode = update_locationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = update_location.class.getClassLoader().getResourceAsStream("local_wash_new/update_location_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = update_location.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : update_location");
        }
...
/************************************************************************************************
 *     91392 characters generated by Talend Open Studio for Data Integration 
 *     on the 20 November, 2019 4:37:40 PM IST
 ************************************************************************************************/