...
package local_wash_new.wa_call_content_0_1;
...
/**
 * Job: WA_Call_Content Purpose: WA_Call_Content<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class WA_Call_Content implements TalendJob {
...
public String getMotech_db_Port(){
	...
	private final String jobName = "WA_Call_Content";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				WA_Call_Content.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(WA_Call_Content.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_WA_Call_Content = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_WA_Call_Content = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_WASH_NEW_WA_Call_Content.length) {
				if(length < 1024 && commonByteArray_LOCAL_WASH_NEW_WA_Call_Content.length == 0) {
   					commonByteArray_LOCAL_WASH_NEW_WA_Call_Content = new byte[1024];
				} else {
   					commonByteArray_LOCAL_WASH_NEW_WA_Call_Content = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_WASH_NEW_WA_Call_Content, 0, length);
			strReturn = new String(commonByteArray_LOCAL_WASH_NEW_WA_Call_Content, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_WASH_NEW_WA_Call_Content) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[D97nYJ1cWoBBbwTKQeICIsKLJEunOOEQYPQDtIvD38mIGRzJ]");
...
public static class ma_call_contentStruct implements routines.system.IPersistableRow<ma_call_contentStruct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_WA_Call_Content = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_WA_Call_Content = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final ma_call_contentStruct other = (ma_call_contentStruct) obj;
	...
	public void copyDataTo(ma_call_contentStruct other) {
	...
	public void copyKeysDataTo(ma_call_contentStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(ma_call_contentStruct other) {
...
ma_call_contentStruct ma_call_content = new ma_call_contentStruct();
	...
	currentComponent="tMysqlOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ma_call_content");
					}
...
String tableName_tMysqlOutput_1 = "WA_call_content_measure";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[CHExEUa4gIAKXRmZIrqFeoUSdFsNEIg3wISw92WPD3hPcXGd]");
...
int count_tMysqlOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tMysqlOutput_1 = dbMetaData_tMysqlOutput_1.getTables("WAReporting", null, null, new String[]{"TABLE"})) {
                                    while(rsTable_tMysqlOutput_1.next()) {
                                        ...
                                        if(table_tMysqlOutput_1.equalsIgnoreCase("WA_call_content_measure")) {
                                ...
                                if(!whetherExist_tMysqlOutput_1) {
                                    try (java.sql.Statement stmtCreate_tMysqlOutput_1 = conn_tMysqlOutput_1.createStatement()) {
                                        stmtCreate_tMysqlOutput_1.execute("CREATE TABLE `" + tableName_tMysqlOutput_1 + "`(`id` BIGINT(8)  ,`call_detail_id` BIGINT(8)  ,`completion_flag` BIT(1)  ,`correct_answer_entered` BIT(1)  ,`duration` BIGINT(11)  ,`start_time` VARCHAR(255)  ,`end_time` VARCHAR(255)  ,`type` VARCHAR(255)  ,`modificationDate` VARCHAR(255)  ,primary key(`id`))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "WA_call_content_measure" + "` WHERE `id` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_1", pstmt_tMysqlOutput_1);
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "WA_call_content_measure" + "` (`id`,`call_detail_id`,`completion_flag`,`correct_answer_entered`,`duration`,`start_time`,`end_time`,`type`,`modificationDate`) VALUES (?,?,?,?,?,?,?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "WA_call_content_measure" + "` SET `call_detail_id` = ?,`completion_flag` = ?,`correct_answer_entered` = ?,`duration` = ?,`start_time` = ?,`end_time` = ?,`type` = ?,`modificationDate` = ? WHERE `id` = ?";
...
ma_call_contentStruct ma_call_content_tmp = new ma_call_contentStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[87x8NCfz3YZivj6pKJzomaLDHejcqk6mfGLjpRJGaRg7cPcL]");
		    ...
		    String dbquery_tMysqlInput_2 = "SELECT cc.id,\ncc.callDetailRecord_id_OID as 'call_detail_id',\ncc.completionFlag,\ncc.correctAnswerEntered, \nTIMESTAMPDIF"
+"F(SECOND,cc.startTime, cc.endTime) as 'duration',\ncc.startTime, cc.endTime, cc.type, cc.modificationDate\nFROM wash_call_"
+"content cc\nWHERE cc.washAcademyCardCode IS NULL\nAND cc.creationDate>'"+(String)globalMap.get("lastEtlTime")+"'\nORDER BY cc.creationDate ASC";
            ...
            if(rs_tMysqlInput_2.wasNull()){
                    row3.id = null;
							...
							if(colQtyInRs_tMysqlInput_2 < 2) {
								row3.call_detail_id = null;
							} else {
		                          
            row3.call_detail_id = rs_tMysqlInput_2.getLong(2);
            if(rs_tMysqlInput_2.wasNull()){
                    row3.call_detail_id = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_2 < 3) {
								row3.completionFlag = null;
							} else {
	                         		
            row3.completionFlag = rs_tMysqlInput_2.getBoolean(3);
            if(rs_tMysqlInput_2.wasNull()){
                    row3.completionFlag = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_2 < 4) {
								row3.correctAnswerEntered = null;
							} else {
	                         		
            row3.correctAnswerEntered = rs_tMysqlInput_2.getBoolean(4);
            if(rs_tMysqlInput_2.wasNull()){
                    row3.correctAnswerEntered = null;
            }
		                    }
            ...
            row3.duration = rs_tMysqlInput_2.getLong(5);
            if(rs_tMysqlInput_2.wasNull()){
                    row3.duration = null;
            }
		                    }
        	...
        	row3.startTime = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 6, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 7) {
								row3.endTime = null;
							} else {
	                         		
        	row3.endTime = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 7, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 8) {
								row3.type = null;
							} else {
	                         		
        	row3.type = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 8, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 9) {
								row3.modificationDate = null;
							} else {
	                         		
        	row3.modificationDate = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 9, false);
		                    }
...
ma_call_content = null;


// # Output table : 'ma_call_content'
ma_call_content_tmp.id = row3.id;
ma_call_content_tmp.call_detail_id = row3.call_detail_id;
ma_call_content_tmp.completion_flag = row3.completionFlag ;
ma_call_content_tmp.correct_answer_entered = row3.correctAnswerEntered ;
ma_call_content_tmp.duration = row3.duration;
ma_call_content_tmp.start_time = row3.startTime ;
ma_call_content_tmp.end_time = row3.endTime ;
ma_call_content_tmp.type = row3.type;
ma_call_content_tmp.modificationDate = row3.modificationDate;
ma_call_content = ma_call_content_tmp;
// ###############################
 ...
 */
// Start of branch "ma_call_content"
if(ma_call_content != null) { 
	...
	currentComponent="tMysqlOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"ma_call_content");
					}
        ...
        whetherReject_tMysqlOutput_1 = false;
                    if(ma_call_content.id == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setLong(1, ma_call_content.id);
}
            ...
            if(checkCount_tMysqlOutput_1 > 0) {
                        if(ma_call_content.call_detail_id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(1, ma_call_content.call_detail_id);
}

                        if(ma_call_content.completion_flag == null) {
pstmtUpdate_tMysqlOutput_1.setNull(2, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tMysqlOutput_1.setBoolean(2, ma_call_content.completion_flag);
}

                        if(ma_call_content.correct_answer_entered == null) {
pstmtUpdate_tMysqlOutput_1.setNull(3, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tMysqlOutput_1.setBoolean(3, ma_call_content.correct_answer_entered);
}

                        if(ma_call_content.duration == null) {
pstmtUpdate_tMysqlOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(4, ma_call_content.duration);
}

                        if(ma_call_content.start_time == null) {
pstmtUpdate_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(5, ma_call_content.start_time);
}

                        if(ma_call_content.end_time == null) {
pstmtUpdate_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(6, ma_call_content.end_time);
}

                        if(ma_call_content.type == null) {
pstmtUpdate_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(7, ma_call_content.type);
}

                        if(ma_call_content.modificationDate == null) {
pstmtUpdate_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(8, ma_call_content.modificationDate);
}

                        if(ma_call_content.id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(9 + count_tMysqlOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(9 + count_tMysqlOutput_1, ma_call_content.id);
}
...
} else {pstmtInsert_tMysqlOutput_1.setLong(1, ma_call_content.id);
}

                        if(ma_call_content.call_detail_id == null) {
pstmtInsert_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(2, ma_call_content.call_detail_id);
}

                        if(ma_call_content.completion_flag == null) {
pstmtInsert_tMysqlOutput_1.setNull(3, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tMysqlOutput_1.setBoolean(3, ma_call_content.completion_flag);
}

                        if(ma_call_content.correct_answer_entered == null) {
pstmtInsert_tMysqlOutput_1.setNull(4, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tMysqlOutput_1.setBoolean(4, ma_call_content.correct_answer_entered);
}

                        if(ma_call_content.duration == null) {
pstmtInsert_tMysqlOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(5, ma_call_content.duration);
}

                        if(ma_call_content.start_time == null) {
pstmtInsert_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(6, ma_call_content.start_time);
}

                        if(ma_call_content.end_time == null) {
pstmtInsert_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(7, ma_call_content.end_time);
}

                        if(ma_call_content.type == null) {
pstmtInsert_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(8, ma_call_content.type);
}

                        if(ma_call_content.modificationDate == null) {
pstmtInsert_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(9, ma_call_content.modificationDate);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ma_call_content");
			  	}
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[JncJDTyVhiimAxT3GX9NBZH1HpBkAuSSmCt+tJjk6g8wjlVe]");
...
query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from WA_call_content_measure),\nE"
 ...
 */
    ...
    public static void main(String[] args){
        final WA_Call_Content WA_Call_ContentClass = new WA_Call_Content();

        int exitCode = WA_Call_ContentClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = WA_Call_Content.class.getClassLoader().getResourceAsStream("local_wash_new/wa_call_content_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = WA_Call_Content.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : WA_Call_Content");
        }
...
/************************************************************************************************
 *     109984 characters generated by Talend Open Studio for Data Integration 
