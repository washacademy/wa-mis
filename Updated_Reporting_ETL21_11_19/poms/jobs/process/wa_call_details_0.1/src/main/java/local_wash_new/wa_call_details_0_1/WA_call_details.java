...
package local_wash_new.wa_call_details_0_1;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_WA_call_details = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_WA_call_details = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_WASH_NEW_WA_call_details.length) {
				if(length < 1024 && commonByteArray_LOCAL_WASH_NEW_WA_call_details.length == 0) {
   					commonByteArray_LOCAL_WASH_NEW_WA_call_details = new byte[1024];
				} else {
   					commonByteArray_LOCAL_WASH_NEW_WA_call_details = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_WASH_NEW_WA_call_details, 0, length);
			strReturn = new String(commonByteArray_LOCAL_WASH_NEW_WA_call_details, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_WASH_NEW_WA_call_details) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[fD8INlN2SciDuV653zHqz8qvcs3jqJ6Tzvf4Ef7l2Dni9Fb+]");
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[HViG6Lp+Uhpb/r2+BIneExJ2C25LlcrWXenFGmvJCuFa70yR]");
...
int count_tMysqlOutput_1=0;
	    ...
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "WA_call_detail_measure" + "` (`id`,`swc_id`,`mobile_number`,`operator_id`,`circle_id`,`start_time`,`end_time`,`duration`,`duration_in_pulse`,`call_id`,`modificationDate`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "WA_call_detail_measure" + "` SET `swc_id` = ?,`mobile_number` = ?,`operator_id` = ?,`circle_id` = ?,`start_time` = ?,`end_time` = ?,`duration` = ?,`duration_in_pulse` = ?,`call_id` = ?,`modificationDate` = ? WHERE `id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[0r6OQyDYlFej0CVhD2RQD/+PQtVpYsieVWOK29BfuCXADqzJ]");
...
pstmtUpdate_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
                        ...
                        if(ma_call_details.id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(11 + count_tMysqlOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(11 + count_tMysqlOutput_1, ma_call_details.id);
}
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[sfeCe2TEpVURlLBjbGnHtshhvodvYbfthozwE8wNGtSDsiaP]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = WA_call_details.class.getClassLoader().getResourceAsStream("local_wash_new/wa_call_details_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     110756 characters generated by Talend Open Studio for Data Integration 
