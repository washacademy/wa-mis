...
package local_wash_new.wa_course_completion_0_1;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_WA_Course_Completion = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_WA_Course_Completion = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_WASH_NEW_WA_Course_Completion.length) {
				if(length < 1024 && commonByteArray_LOCAL_WASH_NEW_WA_Course_Completion.length == 0) {
   					commonByteArray_LOCAL_WASH_NEW_WA_Course_Completion = new byte[1024];
				} else {
   					commonByteArray_LOCAL_WASH_NEW_WA_Course_Completion = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_WASH_NEW_WA_Course_Completion, 0, length);
			strReturn = new String(commonByteArray_LOCAL_WASH_NEW_WA_Course_Completion, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_WASH_NEW_WA_Course_Completion) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[2XYEA2V4rwNIp0z2xCMUG+DqzO0apRDoY0q13vi6+n8Wr+68]");
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[8DYQkrfNCgE5ppJSfWQrq4VZ66vEjH4d7NE8cE3m9ReTqldu]");
...
int count_tMysqlOutput_1=0;
                                ...
                                if(!whetherExist_tMysqlOutput_1) {
                                    try (java.sql.Statement stmtCreate_tMysqlOutput_1 = conn_tMysqlOutput_1.createStatement()) {
                                        stmtCreate_tMysqlOutput_1.execute("CREATE TABLE `" + tableName_tMysqlOutput_1 + "`(`id` INT(0)  ,`swc_id` BIGINT(0)  ,`score` INT(0)  ,`has_passed` BIT(1)  ,`chapter_wise_score` VARCHAR(255)  ,`last_delivery_status` VARCHAR(0)  ,`sent_notification` BIT(1)  ,`creation_date` VARCHAR(0)  ,`last_modified` VARCHAR(0)  ,primary key(`id`))");
                                    }
                                }

				String insert_tMysqlOutput_1 = "INSERT INTO `" + "WA_course_completion" + "` (`id`,`swc_id`,`score`,`has_passed`,`chapter_wise_score`,`last_delivery_status`,`sent_notification`,`creation_date`,`last_modified`) VALUES (?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[dulU6V1xPUrazdnUMLUj9fXlHZNmnckyy24ZihEnbArbeRTY]");
...
+"te,\nmodificationDate as 'last_modified' from wash_course_completion_records\nwhere modificationDate >'"+(String)globalMap.get("lastEtlTime")+"'";
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[GmM1BFGMVxcKORlA+QNZkH+xHQyFvMAq3isgHtcqdXUYHr5i]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = WA_Course_Completion.class.getClassLoader().getResourceAsStream("local_wash_new/wa_course_completion_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     107350 characters generated by Talend Open Studio for Data Integration 
