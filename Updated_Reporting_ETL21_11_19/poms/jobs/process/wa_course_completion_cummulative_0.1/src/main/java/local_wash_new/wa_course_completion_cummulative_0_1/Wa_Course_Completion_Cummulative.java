...
package local_wash_new.wa_course_completion_cummulative_0_1;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative = new byte[0];
    static byte[] commonByteArray_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative.length) {
				if(length < 1024 && commonByteArray_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative.length == 0) {
   					commonByteArray_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative = new byte[1024];
				} else {
   					commonByteArray_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative, 0, length);
			strReturn = new String(commonByteArray_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_WASH_NEW_Wa_Course_Completion_Cummulative) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[+0GDpGY7FiOMYHBK5xO+tZKRfiyjg1JBtjnu+/Ow7CKGtD9b]");
...
java.sql.Connection conn_tMysqlOutput_2 = null;
	...
	final String decryptedPassword_tMysqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[9gia9o5HBDlB72GNpp9reBbm5O2vxHonHu8PqZ9LtIZqL3t7]");
...
int count_tMysqlOutput_2=0;
                                ...
                                try (java.sql.ResultSet rsTable_tMysqlOutput_2 = dbMetaData_tMysqlOutput_2.getTables("WAReporting", null, null, new String[]{"TABLE"})) {
                                    while(rsTable_tMysqlOutput_2.next()) {
                                        ...
                                        if(table_tMysqlOutput_2.equalsIgnoreCase("WA_course_completion_first")) {
                                ...
                                if(!whetherExist_tMysqlOutput_2) {
                                    try (java.sql.Statement stmtCreate_tMysqlOutput_2 = conn_tMysqlOutput_2.createStatement()) {
                                        stmtCreate_tMysqlOutput_2.execute("CREATE TABLE `" + tableName_tMysqlOutput_2 + "`(`swc_id` BIGINT(0)   not null ,`mobile_number` BIGINT(0)  ,`state_id` INT(0)  ,`district_id` INT(0)  ,`panchayat_id` INT(0)  ,`block_id` BIGINT(0)  ,`swc_name` VARCHAR(0)  ,`creation_date` VARCHAR(0)  ,`job_status` VARCHAR(0)  ,`first_completion` VARCHAR(0)  ,`sent_notification` BIT(0)  ,primary key(`swc_id`))");
                                    }
                                }
	    String update_tMysqlOutput_2 = "UPDATE `" + "WA_course_completion_first" + "` SET `mobile_number` = ?,`state_id` = ?,`district_id` = ?,`panchayat_id` = ?,`block_id` = ?,`swc_name` = ?,`creation_date` = ?,`job_status` = ?,`first_completion` = ?,`sent_notification` = ? WHERE `swc_id` = ?";
	    ...
	    String insert_tMysqlOutput_2 = "INSERT INTO `" + "WA_course_completion_first" + "` (`swc_id`,`mobile_number`,`state_id`,`district_id`,`panchayat_id`,`block_id`,`swc_name`,`creation_date`,`job_status`,`first_completion`,`sent_notification`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[CjUj61W5Gbg4rg6MNnv3Wb42cPA2DaJ+Be1YVJ7q+rwBijQO]");
		    ...
		    String dbquery_tMysqlInput_3 = "select * from \n(select flw.swc_id,flw.mobile_number,flw.state_id,\nflw.district_id,flw.panchayat_id, flw.block_id, \nflw."
+"name,flw.creation_date,flw.job_status, \nmcc.last_modified,mcc.sent_notification \nfrom WA_course_completion mcc \njoin swa"
+"chchagrahi flw \non flw.swc_id = mcc.swc_id \nwhere mcc.has_passed = 1 and \nflw.job_status = 'ACTIVE') a group by \na.swc_i"
+"d, a.mobile_number,a.state_id,a.district_id,\na.panchayat_id, a.block_id, a.name,a.creation_date,\na.job_status, a.last_mo"
+"dified,a.sent_notification \nhaving min(a.last_modified)";
        	...
        	row4.last_modified = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 10, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 11) {
								row4.sent_notification = null;
							} else {
	                         		
            row4.sent_notification = rs_tMysqlInput_3.getBoolean(11);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.sent_notification = null;
            }
		                    }
...
copyOfMa_course_completion_data_tmp.first_completion = row4.last_modified ;
...
pstmtUpdate_tMysqlOutput_2.setNull(10, java.sql.Types.BOOLEAN);
                    ...
                    pstmtUpdate_tMysqlOutput_2.setLong(11 + count_tMysqlOutput_2, copyOfMa_course_completion_data.swc_id);
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[+hwlB9jOhlhjZKIS6zxH6y+Kji7LRt0oVt0Qn9QqdFyRQJut]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Wa_Course_Completion_Cummulative.class.getClassLoader().getResourceAsStream("local_wash_new/wa_course_completion_cummulative_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     113118 characters generated by Talend Open Studio for Data Integration 
 *     on the 21 November, 2019 1:39:23 PM IST
 ************************************************************************************************/