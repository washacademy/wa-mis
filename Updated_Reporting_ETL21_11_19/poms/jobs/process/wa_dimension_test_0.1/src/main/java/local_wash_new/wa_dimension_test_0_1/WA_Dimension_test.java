...
package local_wash_new.wa_dimension_test_0_1;
...
public class WA_Dimension_test implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_WASH_NEW_WA_Dimension_test = new byte[0];
		static byte[] commonByteArray_LOCAL_WASH_NEW_WA_Dimension_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_WASH_NEW_WA_Dimension_test.length) {
					if (length < 1024 && commonByteArray_LOCAL_WASH_NEW_WA_Dimension_test.length == 0) {
						commonByteArray_LOCAL_WASH_NEW_WA_Dimension_test = new byte[1024];
					} else {
						commonByteArray_LOCAL_WASH_NEW_WA_Dimension_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_WASH_NEW_WA_Dimension_test, 0, length);
				strReturn = new String(commonByteArray_LOCAL_WASH_NEW_WA_Dimension_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_WASH_NEW_WA_Dimension_test) {
...
// Start of branch "row1"
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[WTEl7z6lW/HytSOqt5AZqi3RB6Q1DvRuF5f7rbkFykOnoCvg]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WA_Dimension_test.class.getClassLoader()
					.getResourceAsStream("local_wash_new/wa_dimension_test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 59378 characters generated by Talend Open Studio for Data Integration on the
 * 20 November, 2019 1:59:19 PM IST
 ************************************************************************************************/