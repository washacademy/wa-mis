...
package local_wash_new.wa_imi_cdrs_job_0_1;
...
/**
 * Job: wa_imi_cdrs_job Purpose: wa_imi_cdrs_job<br>
 * Description: wa_imi_cdrs_job <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class wa_imi_cdrs_job implements TalendJob {
	...
	private final String jobName = "wa_imi_cdrs_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					wa_imi_cdrs_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(wa_imi_cdrs_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("nms_imi_cdrs ETL Started......................");
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.wa_imi_cdrs_0_1.wa_imi_cdrs childJob_tRunJob_2 = new local_wash_new.wa_imi_cdrs_0_1.wa_imi_cdrs();
				// pass DataSources
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
						.format(java.util.Calendar.getInstance().getTime()));
				System.out.println("nms_imi_cdrs ETL Ended......................");
	...
	public void tJava_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
						.format(java.util.Calendar.getInstance().getTime()));
				System.out.println("Error occured in nms_imi_cdrs ETL execution, Refer log printed above");
	...
	public static void main(String[] args) {
		final wa_imi_cdrs_job wa_imi_cdrs_jobClass = new wa_imi_cdrs_job();

		int exitCode = wa_imi_cdrs_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = wa_imi_cdrs_job.class.getClassLoader()
					.getResourceAsStream("local_wash_new/wa_imi_cdrs_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = wa_imi_cdrs_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : wa_imi_cdrs_job");
		}
...
/************************************************************************************************
 * 57325 characters generated by Talend Open Studio for Data Integration on the
 * 19 November, 2019 4:27:43 PM IST
 ************************************************************************************************/