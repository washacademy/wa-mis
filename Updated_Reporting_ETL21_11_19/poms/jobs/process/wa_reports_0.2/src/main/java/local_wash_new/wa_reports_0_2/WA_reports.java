...
package local_wash_new.wa_reports_0_2;
...
/**
 * Job: WA_reports Purpose: WA_MK_Data<br>
 ...
 * @status
 */
public class WA_reports implements TalendJob {
	...
	private final String jobName = "WA_reports";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WA_reports.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.wa_circle_wise_anonymous_users_0_1.WA_Circle_wise_Anonymous_Users childJob_tRunJob_4 = new local_wash_new.wa_circle_wise_anonymous_users_0_1.WA_Circle_wise_Anonymous_Users();
				// pass DataSources
	...
	public static void main(String[] args) {
		final WA_reports WA_reportsClass = new WA_reports();

		int exitCode = WA_reportsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WA_reports.class.getClassLoader()
					.getResourceAsStream("local_wash_new/wa_reports_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WA_reports.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : WA_reports");
		}
...
/************************************************************************************************
 * 54402 characters generated by Talend Open Studio for Data Integration on the
 * 19 November, 2019 4:30:52 PM IST
 ************************************************************************************************/