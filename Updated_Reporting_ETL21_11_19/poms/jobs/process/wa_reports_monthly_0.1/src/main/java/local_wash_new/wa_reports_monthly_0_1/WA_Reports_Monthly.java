...
package local_wash_new.wa_reports_monthly_0_1;
...
/**
 * Job: WA_Reports_Monthly Purpose: WA_Reports_Monthly<br>
 * Description: WA_Reports_Monthly <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class WA_Reports_Monthly implements TalendJob {
	...
	private final String jobName = "WA_Reports_Monthly";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					WA_Reports_Monthly.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WA_Reports_Monthly.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("MA Monthly ETL Started......................");
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_3 = new local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.wa_circle_wise_anonymous_users_0_1.WA_Circle_wise_Anonymous_Users childJob_tRunJob_1 = new local_wash_new.wa_circle_wise_anonymous_users_0_1.WA_Circle_wise_Anonymous_Users();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.wa_course_completion_cummulative_0_1.Wa_Course_Completion_Cummulative childJob_tRunJob_2 = new local_wash_new.wa_course_completion_cummulative_0_1.Wa_Course_Completion_Cummulative();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_5 = new local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
				// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
						.format(java.util.Calendar.getInstance().getTime()));
				System.out.println(
						"Error occured in MA Cumulative Course Completion etl execution, Refer log printed above");
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_6 = new local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
				// pass DataSources
	...
	public void tJava_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
						.format(java.util.Calendar.getInstance().getTime()));
				System.out.println("MA Monthly ETL Ended......................");
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_4 = new local_wash_new.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
				// pass DataSources
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
						.format(java.util.Calendar.getInstance().getTime()));
				System.out.println("Error occured in MA_Anonymous etl execution, Refer log printed above");
	...
	public static void main(String[] args) {
		final WA_Reports_Monthly WA_Reports_MonthlyClass = new WA_Reports_Monthly();

		int exitCode = WA_Reports_MonthlyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WA_Reports_Monthly.class.getClassLoader().getResourceAsStream(
					"local_wash_new/wa_reports_monthly_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WA_Reports_Monthly.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : WA_Reports_Monthly");
		}
...
/************************************************************************************************
 * 74256 characters generated by Talend Open Studio for Data Integration on the
 * 19 November, 2019 4:30:18 PM IST
 ************************************************************************************************/