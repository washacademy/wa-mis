...
public class WACompletionLineListing {
    ...
    @Column(name = "state_name", columnDefinition = "VARCHAR(255)")
    ...
    @Column(name = "block_name", columnDefinition = "VARCHAR(255)")
    private String blockName;

    @Column(name = "panchayat_id", columnDefinition = "BIGINT(20)")
    private Integer panchayatId;

    @Column(name = "panchayat_name", columnDefinition = "VARCHAR(255)")
    ...
    @Column(name = "SMS_sent_notification", columnDefinition = "VARCHAR(255)")
