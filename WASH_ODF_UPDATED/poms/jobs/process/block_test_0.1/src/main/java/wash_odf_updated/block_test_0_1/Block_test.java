...
package wash_odf_updated.block_test_0_1;
...
/**
 * Job: Block_test Purpose: New block method<br>
 * Description: New block method <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class Block_test implements TalendJob {
...
public String getMotech_db_Server(){
	...
	private final String jobName = "Block_test";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Block_test.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_Block_test = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_Block_test = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_Block_test.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_Block_test.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_Block_test = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_Block_test = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_Block_test, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_Block_test, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_Block_test) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[ur0j7oXb0deinGsTquRF3PqN633LcbQJIPTzs3v7tkmtR/yG]");
...
// output_row.id = row2.id * 2;
//
// lowercase the name
// output_row.name = row2.name.toLowerCase();
...
String tableName_tMysqlOutput_1 = "dim_block";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[+sy2F7a3pcdFFrvpXFZ/E2QpxTWL3yMttkuEYZImRVkAg8fC]");
...
int count_tMysqlOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "dim_block" + "` WHERE `loc_id` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_1", pstmt_tMysqlOutput_1);
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "dim_block" + "` (`loc_id`,`block_name`,`state_id`,`district_id`,`last_modified`) VALUES (?,?,?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "dim_block" + "` SET `block_name` = ?,`state_id` = ?,`district_id` = ?,`last_modified` = ? WHERE `loc_id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[0MZJyjFo+f1sDVpr8PI3z4kzc+FAMEn/I96V96HJmjuHGnt/]");
		    ...
		    String dbquery_tMysqlInput_1 = "select wb.id as 'block_id', wb.name, d.state_id_OID as 'state_id', d.id as 'district_id',\n  wb.modificationDate\nfrom wa"
+"sh_blocks as wb\njoin wash_districts as d on wb.district_id_OID = d.id\nWHERE wb.creationDate>'"+(String)globalMap.get("lastEtlTime")+"'\nOR wb.modificationDate >'"+(String)globalMap.get("lastEtlTime")+"'";
            ...
            row1.block_id = rs_tMysqlInput_1.getLong(1);
            ...
            row1.state_id = rs_tMysqlInput_1.getLong(3);
            if(rs_tMysqlInput_1.wasNull()){
                    row1.state_id = null;
            }
		                    }
            ...
            row1.district_id = rs_tMysqlInput_1.getLong(4);
            if(rs_tMysqlInput_1.wasNull()){
                    row1.district_id = null;
            }
		                    }
        	...
        	row1.modificationDate = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 5, false);
		                    }
...
// # Output table : 'output'
output_tmp.loc_id = row1.block_id ;
output_tmp.block_name = row1.name ;
...
if(output != null) { 
	...
	currentComponent="tMysqlOutput_1";
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setLong(1, output.loc_id);
            ...
            if(checkCount_tMysqlOutput_1 > 0) {
                        if(output.block_name == null) {
pstmtUpdate_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(1, output.block_name);
}

                        if(output.state_id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(2, output.state_id);
}

                        if(output.district_id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(3, output.district_id);
}

                        if(output.last_modified == null) {
pstmtUpdate_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(4, output.last_modified);
}

                        pstmtUpdate_tMysqlOutput_1.setLong(5 + count_tMysqlOutput_1, output.loc_id);
                ...
                try {
                    ...
                    whetherReject_tMysqlOutput_1 = true;
                        ...
                        pstmtInsert_tMysqlOutput_1.setLong(1, output.loc_id);

                        if(output.block_name == null) {
pstmtInsert_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(2, output.block_name);
}

                        if(output.state_id == null) {
pstmtInsert_tMysqlOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(3, output.state_id);
}

                        if(output.district_id == null) {
pstmtInsert_tMysqlOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(4, output.district_id);
}

                        if(output.last_modified == null) {
pstmtInsert_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(5, output.last_modified);
}
...
public static class taluka_id_updateStruct implements routines.system.IPersistableRow<taluka_id_updateStruct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_Block_test = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_Block_test = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final taluka_id_updateStruct other = (taluka_id_updateStruct) obj;
	...
	public void copyDataTo(taluka_id_updateStruct other) {
	...
	public void copyKeysDataTo(taluka_id_updateStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(taluka_id_updateStruct other) {
...
taluka_id_updateStruct taluka_id_update = new taluka_id_updateStruct();
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"taluka_id_update");
					}
...
String tableName_tMysqlOutput_2 = "dim_block";
...
java.sql.Connection conn_tMysqlOutput_2 = null;
	...
	final String decryptedPassword_tMysqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[++UhAsVPpqVXSKu8MZoVvjIQTfgZ7TJ9pfPDAATBNyO5I+2z]");
...
int count_tMysqlOutput_2=0;
	    ...
	    String update_tMysqlOutput_2 = "UPDATE `" + "dim_block" + "` SET `state_id` = ?,`district_id` = ? WHERE `loc_id` = ?";
...
// ###############################
// # Outputs initialization
taluka_id_updateStruct taluka_id_update_tmp = new taluka_id_updateStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[zSoYixTjImaDsZ0M6jsUNncj28wrGn9aoCC1ypraRjEOtHoC]");
		    ...
		    String dbquery_tMysqlInput_3 = "select p.state_id as 'state_id',\np.district_id as 'district_id',b.loc_id as 'block_id' from dim_panchayat p\njoin dim_bl"
+"ock b on b.loc_id = p.block_id";
            ...
            row4.block_id = rs_tMysqlInput_3.getInt(3);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.block_id = null;
            }
		                    }
...
taluka_id_update = null;


// # Output table : 'taluka_id_update'
taluka_id_update_tmp.state_id = row4.state_id ;
taluka_id_update_tmp.district_id = row4.district_id ;
taluka_id_update_tmp.loc_id = row4.block_id ;
taluka_id_update = taluka_id_update_tmp;
// ###############################
 ...
 */
// Start of branch "taluka_id_update"
if(taluka_id_update != null) { 
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"taluka_id_update");
					}
        ...
        whetherReject_tMysqlOutput_2 = false;
                    if(taluka_id_update.state_id == null) {
pstmt_tMysqlOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(1, taluka_id_update.state_id);
}

                    if(taluka_id_update.district_id == null) {
pstmt_tMysqlOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(2, taluka_id_update.district_id);
}


                    if(taluka_id_update.loc_id == null) {
pstmt_tMysqlOutput_2.setNull(3 + count_tMysqlOutput_2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(3 + count_tMysqlOutput_2, taluka_id_update.loc_id);
}
...
} // End of branch "taluka_id_update"
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_2=nb_line_rejected_tMysqlOutput_2 + rejectedCount_tMysqlOutput_2;
        ...
        globalMap.put("tMysqlOutput_2_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"taluka_id_update");
			  	}
...
String tableName_tMysqlOutput_3 = "dim_block";
...
java.sql.Connection conn_tMysqlOutput_3 = null;
	...
	final String decryptedPassword_tMysqlOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[CHJuT6aZV7NJhpeOrwnDyDHPtG1ZGNo7JRkGk3gHP8Ab9WxH]");
...
int count_tMysqlOutput_3=0;
	    ...
	    String update_tMysqlOutput_3 = "UPDATE `" + "dim_block" + "` SET `code` = ? WHERE `loc_id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[pO8LUp/jYca0gtmdwALS0dunp5yiG6TL5xiNjZXA+4JFgc6b]");
		    ...
		    String dbquery_tMysqlInput_4 = "select id, code\nfrom wash_blocks";
...
pstmt_tMysqlOutput_3.setNull(1, java.sql.Types.INTEGER);
                    ...
                    pstmt_tMysqlOutput_3.setLong(2 + count_tMysqlOutput_3, stateCode.loc_id);
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[4HYlrDPXXLxSpcR7PhB+cdBK7qmILTc1s91qt09EprYhKTIc]");
 ...
 */
    ...
    public static void main(String[] args){
        final Block_test Block_testClass = new Block_test();

        int exitCode = Block_testClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Block_test.class.getClassLoader().getResourceAsStream("wash_odf_updated/block_test_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Block_test.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Block_test");
        }
...
/************************************************************************************************
 *     165244 characters generated by Talend Open Studio for Data Integration 
