...
package wash_odf_updated.circle_test_0_1;
...
/**
 * Job: Circle_test Purpose: ETL for circles<br>
 * Description: move nms_circles <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class Circle_test implements TalendJob {
...
public String getMotech_db_Server(){
	...
	private final String jobName = "Circle_test";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Circle_test.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_Circle_test = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_Circle_test = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_Circle_test.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_Circle_test.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_Circle_test = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_Circle_test = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_Circle_test, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_Circle_test, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_Circle_test) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[AUIa8I6u3IrFwLKvbh5exfLO7pvXkkz6TqUeIL4MoMY1RGaf]");
...
public static class outputStruct implements routines.system.IPersistableRow<outputStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.circle_id;
	...
	public boolean equals(Object obj) {
		...
		final outputStruct other = (outputStruct) obj;
						...
						if (this.circle_id != other.circle_id)
							return false;
    ...
    public int compareTo(outputStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.circle_id, other.circle_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
String tableName_tMysqlOutput_1 = "dim_circle";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[URAaxaSGiZMw6nkx0uWLwU0aaBsbSDZjJKZVNOgzJNhfckNm]");
...
int count_tMysqlOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "dim_circle" + "` WHERE `circle_id` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_1", pstmt_tMysqlOutput_1);
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "dim_circle" + "` (`circle_id`,`circle_name`,`last_modified`) VALUES (?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "dim_circle" + "` SET `circle_name` = ?,`last_modified` = ? WHERE `circle_id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[YAtEWXr3y1vqU3vK0NFx1i44lJufO6GRyCv3zLEepuJQogpl]");
        	...
        	row1.name = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 2, false);
		                    }
				...
				if(rs_tMysqlInput_2.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
						row1.modificationDate = rs_tMysqlInput_2.getTimestamp(3);
					} else {
...
// # Output table : 'output'
output_tmp.circle_id = row1.id ;
output_tmp.circle_name = row1.name ;
...
if(output != null) { 
	...
	currentComponent="tMysqlOutput_1";
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setLong(1, output.circle_id);
            ...
            if(checkCount_tMysqlOutput_1 > 0) {
                        if(output.circle_name == null) {
pstmtUpdate_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(1, output.circle_name);
}
...
pstmtUpdate_tMysqlOutput_1.setNull(2, java.sql.Types.DATE);
                        ...
                        pstmtUpdate_tMysqlOutput_1.setLong(3 + count_tMysqlOutput_1, output.circle_id);
                ...
                try {
                    ...
                    whetherReject_tMysqlOutput_1 = true;
                        ...
                        pstmtInsert_tMysqlOutput_1.setLong(1, output.circle_id);

                        if(output.circle_name == null) {
pstmtInsert_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(2, output.circle_name);
}
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[pXUHKzvbrjqa5FTa4d/lPi9ABk9jaFbfN8dwRDV+0I2O5cYV]");
...
query_tMysqlRow_1 = "UPDATE ETL_info_table \nSET \nETL_info_table.last_etl_time = (SELECT MAX(last_modified) from dim_circle),\nETL_info_table."
+"record_count = (SELECT COUNT(*) from dim_circle)\nWHERE \nETL_info_table.table_id = 6";
 ...
 */
    ...
    public static void main(String[] args){
        final Circle_test Circle_testClass = new Circle_test();

        int exitCode = Circle_testClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Circle_test.class.getClassLoader().getResourceAsStream("wash_odf_updated/circle_test_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Circle_test.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Circle_test");
        }
...
/************************************************************************************************
 *     108624 characters generated by Talend Open Studio for Data Integration 
