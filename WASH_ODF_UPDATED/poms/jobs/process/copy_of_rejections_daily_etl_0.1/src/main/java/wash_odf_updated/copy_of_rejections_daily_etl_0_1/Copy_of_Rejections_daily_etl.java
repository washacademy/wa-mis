...
package wash_odf_updated.copy_of_rejections_daily_etl_0_1;
...
/**
 * Job: Copy_of_Rejections_daily_etl Purpose: Rejections_daily_etl<br>
 * Description: Rejections_daily_etl <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class Copy_of_Rejections_daily_etl implements TalendJob {
	...
	private final String jobName = "Copy_of_Rejections_daily_etl";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_Rejections_daily_etl.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_Rejections_daily_etl.this,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tJava_1", Boolean.FALSE);
				...
				System.out.println("Rejections ETL Started......................");
				...
				if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tJava_1")) {
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tRunJob_4", Boolean.FALSE);
				...
				wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_4 = new wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
				// pass DataSources
				...
				if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tRunJob_4")) {
					if (globalMap.get("USE_CONDITION") != null && (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null && (Boolean) globalMap.get("TRACE_CONDITION")) {
							// if next breakpoint has been clicked on UI or if start job, should wait action
							// of user.
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tRunJob_1", Boolean.FALSE);
				...
				wash_odf_updated.swc_rejection_records_0_1.SWC_Rejection_Records childJob_tRunJob_1 = new wash_odf_updated.swc_rejection_records_0_1.SWC_Rejection_Records();
				// pass DataSources
				...
				if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tRunJob_1")) {
					if (globalMap.get("USE_CONDITION") != null && (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null && (Boolean) globalMap.get("TRACE_CONDITION")) {
							// if next breakpoint has been clicked on UI or if start job, should wait action
							// of user.
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tRunJob_5", Boolean.FALSE);
				...
				wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_5 = new wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
				// pass DataSources
				...
				if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tRunJob_5")) {
					if (globalMap.get("USE_CONDITION") != null && (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null && (Boolean) globalMap.get("TRACE_CONDITION")) {
							// if next breakpoint has been clicked on UI or if start job, should wait action
							// of user.
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tJava_2", Boolean.FALSE);
				...
				System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
						.format(java.util.Calendar.getInstance().getTime()));
				System.out.println("Rejections ETL Ended......................");
				...
				if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tJava_2")) {
					if (globalMap.get("USE_CONDITION") != null && (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null && (Boolean) globalMap.get("TRACE_CONDITION")) {
							// if next breakpoint has been clicked on UI or if start job, should wait action
							// of user.
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tRunJob_6", Boolean.FALSE);
				...
				wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_6 = new wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
				// pass DataSources
				...
				if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tRunJob_6")) {
					if (globalMap.get("USE_CONDITION") != null && (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null && (Boolean) globalMap.get("TRACE_CONDITION")) {
							// if next breakpoint has been clicked on UI or if start job, should wait action
							// of user.
	...
	public void tJava_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tJava_3", Boolean.FALSE);
				...
				System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
						.format(java.util.Calendar.getInstance().getTime()));
				System.out.println("Error occured in SWC Rejections table execution, Refer log printed above");
				...
				if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tJava_3")) {
					if (globalMap.get("USE_CONDITION") != null && (Boolean) globalMap.get("USE_CONDITION")) {
						if (globalMap.get("TRACE_CONDITION") != null && (Boolean) globalMap.get("TRACE_CONDITION")) {
							// if next breakpoint has been clicked on UI or if start job, should wait action
							// of user.
	...
	public static void main(String[] args) {
		final Copy_of_Rejections_daily_etl Copy_of_Rejections_daily_etlClass = new Copy_of_Rejections_daily_etl();

		int exitCode = Copy_of_Rejections_daily_etlClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_Rejections_daily_etl.class.getClassLoader().getResourceAsStream(
					"wash_odf_updated/copy_of_rejections_daily_etl_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_Rejections_daily_etl.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_Rejections_daily_etl");
		}
...
/************************************************************************************************
 * 65256 characters generated by Talend Open Studio for Data Integration on the
 * 12 December, 2019 7:51:20 PM IST
 ************************************************************************************************/