...
package wash_odf_updated.dimenison_table_execution_0_1;
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dimenison_Table_Execution.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		wash_odf_updated.language_0_1.Language childJob_tRunJob_7 = new wash_odf_updated.language_0_1.Language();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		wash_odf_updated.state_test_0_1.State_test childJob_tRunJob_1 = new wash_odf_updated.state_test_0_1.State_test();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		wash_odf_updated.district_0_1.District childJob_tRunJob_2 = new wash_odf_updated.district_0_1.District();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		wash_odf_updated.block_test_0_1.Block_test childJob_tRunJob_3 = new wash_odf_updated.block_test_0_1.Block_test();
	    // pass DataSources
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_3:OnSubjobOk1", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
							...
							tRunJob_8Process(globalMap); 
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_3:OnSubjobOk2", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		wash_odf_updated.circle_test_0_1.Circle_test childJob_tRunJob_8 = new wash_odf_updated.circle_test_0_1.Circle_test();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		wash_odf_updated.panchayat_0_1.Panchayat childJob_tRunJob_4 = new wash_odf_updated.panchayat_0_1.Panchayat();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		wash_odf_updated.state_circle_0_1.state_circle childJob_tRunJob_5 = new wash_odf_updated.state_circle_0_1.state_circle();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		wash_odf_updated.deployed_services_0_1.Deployed_Services childJob_tRunJob_6 = new wash_odf_updated.deployed_services_0_1.Deployed_Services();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dimenison_Table_Execution.class.getClassLoader().getResourceAsStream("wash_odf_updated/dimenison_table_execution_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dimenison_Table_Execution.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dimenison_Table_Execution");
        }
...
/************************************************************************************************
 *     74558 characters generated by Talend Open Studio for Data Integration 
