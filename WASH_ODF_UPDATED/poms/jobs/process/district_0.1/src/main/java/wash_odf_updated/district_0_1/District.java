...
package wash_odf_updated.district_0_1;
...
/**
 * Job: District Purpose: To import newly created districts<br>
 * Description: import districts created or modified after last ETL <br>
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(District.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_District = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_District = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_District.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_District.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_District = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_District = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_District, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_District, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_District) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_WASH_ODF_UPDATED_District = new byte[0];
			    ...
			    public java.util.Date last_etl_time;

				public java.util.Date getLast_etl_time () {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_District) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.last_etl_time = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.last_etl_time,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("last_etl_time="+String.valueOf(last_etl_time));
	    sb.append("]");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[av2NcLpOCLSBJRDpwWnOTNR9TxcIB5HZ9CY2J/z0NAZ8shLY]");
		    ...
		    String dbquery_tMysqlInput_1 = "select last_etl_time from ETL_info_table where table_id=2";
		    ...
		    while (rs_tMysqlInput_1.next()) {
				...
				if(rs_tMysqlInput_1.getString(1) != null) {
					String dateString_tMysqlInput_1 = rs_tMysqlInput_1.getString(1);
					if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
						row1.last_etl_time = rs_tMysqlInput_1.getTimestamp(1);
					} else {
						row1.last_etl_time = (java.util.Date) year0_tMysqlInput_1.clone();
					}
				} else {
					row1.last_etl_time =  null;
				}
...
globalMap.put("lastEtlTime",row1.last_etl_time!=null ?row1.last_etl_time:"");
    nb_line_tJavaRow_1++;   
...
public static class districts_to_be_updatedStruct implements routines.system.IPersistableRow<districts_to_be_updatedStruct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_District = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_District = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.loc_id;
	...
	public boolean equals(Object obj) {
		...
		final districts_to_be_updatedStruct other = (districts_to_be_updatedStruct) obj;
	...
	public void copyDataTo(districts_to_be_updatedStruct other) {
	...
	public void copyKeysDataTo(districts_to_be_updatedStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(districts_to_be_updatedStruct other) {
...
districts_to_be_updatedStruct districts_to_be_updated = new districts_to_be_updatedStruct();
	...
	currentComponent="tMysqlOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"districts_to_be_updated");
					}
...
String tableName_tMysqlOutput_1 = "dim_district";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[GA5aQsWNR2luQDGe4Bqp5AX+POg165L+wdJAIxiWfg6OBXB0]");
...
int count_tMysqlOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "dim_district" + "` WHERE `loc_id` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_1", pstmt_tMysqlOutput_1);
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "dim_district" + "` (`district_name`,`state_id`,`loc_id`,`last_modified`) VALUES (?,?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "dim_district" + "` SET `district_name` = ?,`state_id` = ?,`last_modified` = ? WHERE `loc_id` = ?";
...
districts_to_be_updatedStruct districts_to_be_updated_tmp = new districts_to_be_updatedStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[2hEAR35JrbO97LCe+86d7d3Zi06U5zrBhPQleiQxtQ/dGLfZ]");
		    ...
		    String dbquery_tMysqlInput_2 = "select id, name, state_id_OID, modificationDate from \nwash_districts\nwhere creationDate > '" + globalMap.get("lastEtlTime") + "'\nor modificationDate > '" + globalMap.get("lastEtlTime") + "'";
        	...
        	row2.name = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 2, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 3) {
								row2.state_id_OID = 0;
							} else {
		                          
            row2.state_id_OID = rs_tMysqlInput_2.getLong(3);
            if(rs_tMysqlInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
				...
				if(rs_tMysqlInput_2.getString(4) != null) {
					String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(4);
					if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
						row2.modificationDate = rs_tMysqlInput_2.getTimestamp(4);
					} else {
						row2.modificationDate = (java.util.Date) year0_tMysqlInput_2.clone();
					}
				} else {
					row2.modificationDate =  null;
				}
...
districts_to_be_updated = null;


// # Output table : 'districts_to_be_updated'
districts_to_be_updated_tmp.district_name = row2.name ;
districts_to_be_updated_tmp.state_id = row2.state_id_OID ;
districts_to_be_updated_tmp.loc_id = row2.id ;
districts_to_be_updated_tmp.last_modified = row2.modificationDate ;
districts_to_be_updated = districts_to_be_updated_tmp;
// ###############################
 ...
 */
// Start of branch "districts_to_be_updated"
if(districts_to_be_updated != null) { 
	...
	currentComponent="tMysqlOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"districts_to_be_updated");
					}
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setLong(1, districts_to_be_updated.loc_id);
            ...
            if(checkCount_tMysqlOutput_1 > 0) {
                        if(districts_to_be_updated.district_name == null) {
pstmtUpdate_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(1, districts_to_be_updated.district_name);
}

                        pstmtUpdate_tMysqlOutput_1.setLong(2, districts_to_be_updated.state_id);

                        if(districts_to_be_updated.last_modified != null) {
date_tMysqlOutput_1 = districts_to_be_updated.last_modified.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmtUpdate_tMysqlOutput_1.setString(3, "0000-00-00 00:00:00");
} else {pstmtUpdate_tMysqlOutput_1.setTimestamp(3, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmtUpdate_tMysqlOutput_1.setNull(3, java.sql.Types.DATE);
}

                        pstmtUpdate_tMysqlOutput_1.setLong(4 + count_tMysqlOutput_1, districts_to_be_updated.loc_id);
...
} else {pstmtInsert_tMysqlOutput_1.setString(1, districts_to_be_updated.district_name);
}

                        pstmtInsert_tMysqlOutput_1.setLong(2, districts_to_be_updated.state_id);

                        pstmtInsert_tMysqlOutput_1.setLong(3, districts_to_be_updated.loc_id);

                        if(districts_to_be_updated.last_modified != null) {
date_tMysqlOutput_1 = districts_to_be_updated.last_modified.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmtInsert_tMysqlOutput_1.setString(4, "0000-00-00 00:00:00");
} else {pstmtInsert_tMysqlOutput_1.setTimestamp(4, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmtInsert_tMysqlOutput_1.setNull(4, java.sql.Types.DATE);
}
...
} // End of branch "districts_to_be_updated"
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"districts_to_be_updated");
			  	}
...
public static class state_id_updateStruct implements routines.system.IPersistableRow<state_id_updateStruct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_District = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_District = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.district_id == null) ? 0 : this.district_id.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final state_id_updateStruct other = (state_id_updateStruct) obj;
		
						if (this.district_id == null) {
							if (other.district_id != null)
								return false;
						
						} else if (!this.district_id.equals(other.district_id))
	...
	public void copyDataTo(state_id_updateStruct other) {
	...
	public void copyKeysDataTo(state_id_updateStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(state_id_updateStruct other) {

		int returnValue = -1;
		
						returnValue = checkNullsAndCompare(this.district_id, other.district_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
state_id_updateStruct state_id_update = new state_id_updateStruct();
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"state_id_update");
					}
...
String tableName_tMysqlOutput_2 = "dim_district";
...
java.sql.Connection conn_tMysqlOutput_2 = null;
	...
	final String decryptedPassword_tMysqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[xpxW21WD6q7UfJew0ac+wEtz4HWvJvoKMbOoMD6l3LvSiBNF]");
...
int count_tMysqlOutput_2=0;
	    ...
	    String update_tMysqlOutput_2 = "UPDATE `" + "dim_district" + "` SET `state_id` = ?,`circle_id` = ? WHERE `district_id` = ?";
...
// ###############################
// # Outputs initialization
state_id_updateStruct state_id_update_tmp = new state_id_updateStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[whMXM7HKCWrAAujV8/boxaowSzgoMNS2WFWHgsNUSz44JO1B]");
		    ...
		    String dbquery_tMysqlInput_3 = "select s.id as 'state_id',d.district_id as 'district_id' from dim_state s\njoin dim_district d on d.district_id = s.loc_"
+"id";
            ...
            row4.state_id = rs_tMysqlInput_3.getInt(1);
            ...
            row4.district_id = rs_tMysqlInput_3.getInt(2);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.district_id = null;
            }
		                    }
            ...
            row4.circle_id = rs_tMysqlInput_3.getInt(3);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.circle_id = null;
            }
		                    }
...
state_id_update = null;


// # Output table : 'state_id_update'
state_id_update_tmp.state_id = row4.state_id ;
state_id_update_tmp.district_id = row4.district_id ;
state_id_update_tmp.circle_id = row4.circle_id ;
state_id_update = state_id_update_tmp;
// ###############################
 ...
 */
// Start of branch "state_id_update"
if(state_id_update != null) { 
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"state_id_update");
					}
        ...
        whetherReject_tMysqlOutput_2 = false;
                    if(state_id_update.state_id == null) {
pstmt_tMysqlOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(1, state_id_update.state_id);
}

                    if(state_id_update.circle_id == null) {
pstmt_tMysqlOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(2, state_id_update.circle_id);
}


                    if(state_id_update.district_id == null) {
pstmt_tMysqlOutput_2.setNull(3 + count_tMysqlOutput_2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(3 + count_tMysqlOutput_2, state_id_update.district_id);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_2=nb_line_rejected_tMysqlOutput_2 + rejectedCount_tMysqlOutput_2;
        ...
        globalMap.put("tMysqlOutput_2_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"state_id_update");
			  	}
...
public static class stateCodeStruct implements routines.system.IPersistableRow<stateCodeStruct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_District = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_District = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final stateCodeStruct other = (stateCodeStruct) obj;
	...
	public void copyDataTo(stateCodeStruct other) {
	...
	public void copyKeysDataTo(stateCodeStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(stateCodeStruct other) {
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    ...
    static byte[] commonByteArray_WASH_ODF_UPDATED_District = new byte[0];
			    ...
			    public Integer circle_id_OID;

				public Integer getCircle_id_OID () {
					return this.circle_id_OID;
				}
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.id = dis.readLong();
						...
						this.circle_id_OID = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.circle_id_OID,dos);
    ...
    public String toString() {
		...
		sb.append("id="+String.valueOf(id));
		sb.append(",code="+String.valueOf(code));
		sb.append(",circle_id_OID="+String.valueOf(circle_id_OID));
	    sb.append("]");
...
stateCodeStruct stateCode = new stateCodeStruct();
	...
	currentComponent="tMysqlOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"stateCode");
					}
...
String tableName_tMysqlOutput_3 = "dim_district";
...
java.sql.Connection conn_tMysqlOutput_3 = null;
	...
	final String decryptedPassword_tMysqlOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[adMYGQVEQba4XKORStZSwnoXo+L+gZ2tACWPeNvQJsRDGs4W]");
...
int count_tMysqlOutput_3=0;
	    ...
	    String update_tMysqlOutput_3 = "UPDATE `" + "dim_district" + "` SET `code` = ?,`circle_id` = ? WHERE `loc_id` = ?";
...
// ###############################
// # Outputs initialization
stateCodeStruct stateCode_tmp = new stateCodeStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[+aR2OXEUJ+zKyrpUq1OMUwK1Kyd3Yu6Ecmu98ATawbQ8K6+E]");
					
					String dbPwd_tMysqlInput_4 = decryptedPassword_tMysqlInput_4;
				
				String url_tMysqlInput_4 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "motech_data_services" + "?" + context.motech_db_AdditionalParams;
		    ...
		    String dbquery_tMysqlInput_4 = "select id, code,circle_id_OID\nfrom wash_districts";
            ...
            row5.code = rs_tMysqlInput_4.getLong(2);
            if(rs_tMysqlInput_4.wasNull()){
                    row5.code = null;
            }
		                    }
							if(colQtyInRs_tMysqlInput_4 < 3) {
								row5.circle_id_OID = null;
							} else {
		                          
            row5.circle_id_OID = rs_tMysqlInput_4.getInt(3);
            if(rs_tMysqlInput_4.wasNull()){
                    row5.circle_id_OID = null;
            }
		                    }
...
// # Output table : 'stateCode'
stateCode_tmp.loc_id = row5.id ;
stateCode_tmp.code = row5.code ;
stateCode_tmp.circle_id = row5.circle_id_OID ;
stateCode = stateCode_tmp;
// ###############################
...
if(stateCode != null) { 
	...
	currentComponent="tMysqlOutput_3";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"stateCode");
					}
        ...
        whetherReject_tMysqlOutput_3 = false;
                    if(stateCode.code == null) {
pstmt_tMysqlOutput_3.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_3.setLong(1, stateCode.code);
}

                    if(stateCode.circle_id == null) {
pstmt_tMysqlOutput_3.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_3.setInt(2, stateCode.circle_id);
}


                    pstmt_tMysqlOutput_3.setLong(3 + count_tMysqlOutput_3, stateCode.loc_id);
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_3=nb_line_rejected_tMysqlOutput_3 + rejectedCount_tMysqlOutput_3;
        ...
        globalMap.put("tMysqlOutput_3_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"stateCode");
			  	}
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[kuRSCBOFzvxk1Xv1RxlpeENGhUqaUwaJdDBMv61CY+DmX9F8]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = District.class.getClassLoader().getResourceAsStream("wash_odf_updated/district_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = District.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : District");
        }
...
/************************************************************************************************
 *     167019 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 December, 2019 1:25:06 PM IST
 ************************************************************************************************/