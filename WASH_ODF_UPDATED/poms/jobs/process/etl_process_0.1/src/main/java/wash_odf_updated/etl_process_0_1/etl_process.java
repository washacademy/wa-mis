...
package wash_odf_updated.etl_process_0_1;
...
/**
 * Job: etl_process Purpose: etl_process<br>
 * Description: etl_process <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class etl_process implements TalendJob {
	...
	private final String jobName = "etl_process";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(etl_process.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				wash_odf_updated.reporting_etl_job_0_2.Reporting_ETL_Job childJob_tRunJob_2 = new wash_odf_updated.reporting_etl_job_0_2.Reporting_ETL_Job();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				wash_odf_updated.wa_mk_etl_job_0_3.WA_MK_ETL_JOB childJob_tRunJob_3 = new wash_odf_updated.wa_mk_etl_job_0_3.WA_MK_ETL_JOB();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				wash_odf_updated.rejections_daily_etl_0_1.Rejections_daily_etl childJob_tRunJob_1 = new wash_odf_updated.rejections_daily_etl_0_1.Rejections_daily_etl();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				wash_odf_updated.rejections_daily_etl_0_1.Rejections_daily_etl childJob_tRunJob_4 = new wash_odf_updated.rejections_daily_etl_0_1.Rejections_daily_etl();
				// pass DataSources
	...
	public static void main(String[] args) {
		final etl_process etl_processClass = new etl_process();

		int exitCode = etl_processClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = etl_process.class.getClassLoader()
					.getResourceAsStream("wash_odf_updated/etl_process_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = etl_process.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : etl_process");
		}
...
/************************************************************************************************
 * 47362 characters generated by Talend Open Studio for Data Integration on the
 * 12 December, 2019 1:25:11 PM IST
 ************************************************************************************************/