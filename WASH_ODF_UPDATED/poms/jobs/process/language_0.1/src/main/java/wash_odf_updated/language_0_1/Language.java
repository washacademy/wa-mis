...
package wash_odf_updated.language_0_1;
...
/**
 * Job: Language Purpose: Language<br>
 * Description: Language <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class Language implements TalendJob {
...
public String getMotech_db_Port(){
	...
	private final String jobName = "Language";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Language.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_Language = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_Language = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_Language.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_Language.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_Language = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_Language = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_Language, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_Language, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_Language) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[0Zd+B4FUwiqraEEgPxTW55zDhZ6ldgLIQD8YRCDTyb3ga1fE]");
...
String tableName_tMysqlOutput_1 = "dim_language";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[bIQ/8eKSMQhv9+m/hRz5CWh5HwkW0Xo5a5JEFt+jTjdJ4D9i]");
...
int count_tMysqlOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "dim_language" + "` WHERE `id` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_1", pstmt_tMysqlOutput_1);
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "dim_language" + "` (`id`,`code`,`name`,`creation_date`,`last_modified`) VALUES (?,?,?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "dim_language" + "` SET `code` = ?,`name` = ?,`creation_date` = ?,`last_modified` = ? WHERE `id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[mHy5kHsoRs8ll+uYz0Us04zYCWNE+5h1XebN59d8bNsyQOWD]");
            ...
            row1.code = rs_tMysqlInput_2.getInt(2);
            if(rs_tMysqlInput_2.wasNull()){
                    row1.code = null;
            }
		                    }
        	...
        	row1.name = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 3, false);
		                    }
				...
				if(rs_tMysqlInput_2.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
						row1.creationDate = rs_tMysqlInput_2.getTimestamp(4);
					} else {
				...
				if(rs_tMysqlInput_2.getString(5) != null) {
					String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(5);
					if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
						row1.modificationDate = rs_tMysqlInput_2.getTimestamp(5);
					} else {
...
output_tmp.code = row1.code ;
output_tmp.name = row1.name ;
output_tmp.creation_date = row1.creationDate ;
...
if(output != null) { 
	...
	currentComponent="tMysqlOutput_1";
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setLong(1, output.id);
...
} else {pstmtUpdate_tMysqlOutput_1.setInt(1, output.code);
}

                        if(output.name == null) {
pstmtUpdate_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(2, output.name);
}

                        if(output.creation_date != null) {
date_tMysqlOutput_1 = output.creation_date.getTime();
...
pstmtUpdate_tMysqlOutput_1.setNull(4, java.sql.Types.DATE);
                        ...
                        pstmtUpdate_tMysqlOutput_1.setLong(5 + count_tMysqlOutput_1, output.id);
                ...
                try {
                    ...
                    whetherReject_tMysqlOutput_1 = true;
                        ...
                        pstmtInsert_tMysqlOutput_1.setLong(1, output.id);

                        if(output.code == null) {
pstmtInsert_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setInt(2, output.code);
}

                        if(output.name == null) {
pstmtInsert_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(3, output.name);
}
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[DjYI2ZZALggIs1DKwDRg/U7WKBlHuDqFHbNZEJMhCB8c1sWH]");
...
query_tMysqlRow_1 = "UPDATE ETL_info_table \nSET \nETL_info_table.last_etl_time = (SELECT MAX(last_modified) from dim_language),\nETL_info_tabl"
+"e.record_count = (SELECT COUNT(*) from dim_language)\nWHERE \nETL_info_table.table_id = 4";
 ...
 */
    ...
    public static void main(String[] args){
        final Language LanguageClass = new Language();

        int exitCode = LanguageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Language.class.getClassLoader().getResourceAsStream("wash_odf_updated/language_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Language.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Language");
        }
...
/************************************************************************************************
 *     101431 characters generated by Talend Open Studio for Data Integration 
