...
package wash_odf_updated.panchayat_0_1;
...
/**
 * Job: Panchayat Purpose: ETL for panchayats<br>
 * Description: move panchayats from motech_data_services to WAReporting database <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class Panchayat implements TalendJob {
...
public String getMotech_db_Server(){
	...
	private final String jobName = "Panchayat";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Panchayat.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_Panchayat = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_Panchayat = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_Panchayat.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_Panchayat.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_Panchayat = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_Panchayat = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_Panchayat, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_Panchayat, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_Panchayat) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[IL56qh0ZIUHeTfULGlkO9IjdG/DEG+QDVCrY85W8hfPx6N9c]");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    public String toString() {
		...
		sb.append(",district_id="+String.valueOf(district_id));
		sb.append(",state_id="+String.valueOf(state_id));
		sb.append(",vcode="+String.valueOf(vcode));
	    sb.append("]");
...
String tableName_tMysqlOutput_1 = "dim_panchayat";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[OF2WonluftzPGPdCz/Cty5dx8jRYUUzlMkN+ThqdcZVmdUwL]");
...
int count_tMysqlOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "dim_panchayat" + "` WHERE `loc_id` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_1", pstmt_tMysqlOutput_1);
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "dim_panchayat" + "` (`panchayat_name`,`district_id`,`block_id`,`loc_id`,`last_modified`,`state_id`,`code`) VALUES (?,?,?,?,?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "dim_panchayat" + "` SET `panchayat_name` = ?,`district_id` = ?,`block_id` = ?,`last_modified` = ?,`state_id` = ?,`code` = ? WHERE `loc_id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[DV7fp1VecsaO/Zh3U0gcjjcpyem4Hm8YND+ttIFN26obnKbD]");
		    ...
		    String dbquery_tMysqlInput_1 = "SELECT \npanchayat.id as panchayat_id, panchayat.name as panchayat_name, \npanchayat.modificationDate, \npanchayat.block_i"
+"d_OID as 'block_id', \nblock.district_id_OID as 'district_id', \ndistrict.state_id_OID as 'state_id',\npanchayat.vcode\nFROM"
+" \nmotech_data_services.wash_panchayats as panchayat\nLEFT JOIN \nmotech_data_services.wash_blocks as block\non panchayat.bl"
+"ock_id_OID = block.id\nLEFT JOIN\nmotech_data_services.wash_districts as district \non district.id = block.district_id_OID\n"
+"WHERE \npanchayat.creationDate > '"+ globalMap.get("lastEtlTime")+"'\nOR \npanchayat.modificationDate >'"+ globalMap.get("lastEtlTime")+"'";
            ...
            row1.panchayat_id = rs_tMysqlInput_1.getLong(1);
            if(rs_tMysqlInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 2) {
								row1.panchayat_name = null;
							} else {
	                         		
        	row1.panchayat_name = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 2, false);
		                    }
				...
				if(rs_tMysqlInput_1.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
						row1.modificationDate = rs_tMysqlInput_1.getTimestamp(3);
					} else {
						row1.modificationDate = (java.util.Date) year0_tMysqlInput_1.clone();
					}
				} else {
					row1.modificationDate =  null;
				}
        	...
        	row1.block_id = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 4, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 5) {
								row1.district_id = null;
							} else {
		                          
            row1.district_id = rs_tMysqlInput_1.getLong(5);
            if(rs_tMysqlInput_1.wasNull()){
                    row1.district_id = null;
            }
		                    }
            ...
            row1.state_id = rs_tMysqlInput_1.getLong(6);
            if(rs_tMysqlInput_1.wasNull()){
                    row1.state_id = null;
            }
		                    }
            ...
            row1.vcode = rs_tMysqlInput_1.getLong(7);
            if(rs_tMysqlInput_1.wasNull()){
                    row1.vcode = null;
            }
		                    }
...
// # Output table : 'output'
output_tmp.panchayat_name = row1.panchayat_name ;
output_tmp.district_id = row1.district_id ;
output_tmp.block_id = row1.block_id ;
output_tmp.loc_id = row1.panchayat_id ;
output_tmp.last_modified = row1.modificationDate ;
output_tmp.state_id = row1.state_id ;
output_tmp.code = row1.vcode ;
output = output_tmp;
// ###############################
...
if(output != null) { 
	...
	currentComponent="tMysqlOutput_1";
        ...
        whetherReject_tMysqlOutput_1 = false;
                    if(output.loc_id == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setLong(1, output.loc_id);
}
            ...
            if(checkCount_tMysqlOutput_1 > 0) {
                        if(output.panchayat_name == null) {
pstmtUpdate_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(1, output.panchayat_name);
}

                        if(output.district_id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(2, output.district_id);
}

                        if(output.block_id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(3, output.block_id);
}

                        if(output.last_modified != null) {
date_tMysqlOutput_1 = output.last_modified.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmtUpdate_tMysqlOutput_1.setString(4, "0000-00-00 00:00:00");
} else {pstmtUpdate_tMysqlOutput_1.setTimestamp(4, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmtUpdate_tMysqlOutput_1.setNull(4, java.sql.Types.DATE);
}

                        if(output.state_id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(5, output.state_id);
}

                        if(output.code == null) {
pstmtUpdate_tMysqlOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(6, output.code);
}

                        if(output.loc_id == null) {
pstmtUpdate_tMysqlOutput_1.setNull(7 + count_tMysqlOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_1.setLong(7 + count_tMysqlOutput_1, output.loc_id);
}
...
} else {pstmtInsert_tMysqlOutput_1.setString(1, output.panchayat_name);
}

                        if(output.district_id == null) {
pstmtInsert_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(2, output.district_id);
}

                        if(output.block_id == null) {
pstmtInsert_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_1.setString(3, output.block_id);
}

                        if(output.loc_id == null) {
pstmtInsert_tMysqlOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(4, output.loc_id);
}

                        if(output.last_modified != null) {
date_tMysqlOutput_1 = output.last_modified.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmtInsert_tMysqlOutput_1.setString(5, "0000-00-00 00:00:00");
} else {pstmtInsert_tMysqlOutput_1.setTimestamp(5, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmtInsert_tMysqlOutput_1.setNull(5, java.sql.Types.DATE);
}

                        if(output.state_id == null) {
pstmtInsert_tMysqlOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(6, output.state_id);
}

                        if(output.code == null) {
pstmtInsert_tMysqlOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_1.setLong(7, output.code);
}
...
public static class copyOfstate_id_updateStruct implements routines.system.IPersistableRow<copyOfstate_id_updateStruct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_Panchayat = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_Panchayat = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final copyOfstate_id_updateStruct other = (copyOfstate_id_updateStruct) obj;
	...
	public void copyDataTo(copyOfstate_id_updateStruct other) {
	...
	public void copyKeysDataTo(copyOfstate_id_updateStruct other) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_Panchayat) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.block_id = readInteger(dis);
					
					this.district_id = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.block_id,dos);
					
					// String
				
						writeString(this.district_id,dos);
    ...
    public String toString() {
		...
		sb.append(",district_id="+district_id);
		sb.append(",state_id="+String.valueOf(state_id));
     ...
     * Compare keys
     */
    public int compareTo(copyOfstate_id_updateStruct other) {
...
copyOfstate_id_updateStruct copyOfstate_id_update = new copyOfstate_id_updateStruct();
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfstate_id_update");
					}
...
String tableName_tMysqlOutput_2 = "dim_panchayat";
...
java.sql.Connection conn_tMysqlOutput_2 = null;
	...
	final String decryptedPassword_tMysqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[BsxUQ6IXRxAiPWUztjEB8lwEEvNdZq5wfhFhEuqyirGW0LuO]");
...
int count_tMysqlOutput_2=0;
	    ...
	    String update_tMysqlOutput_2 = "UPDATE `" + "dim_panchayat" + "` SET `block_id` = ?,`district_id` = ?,`state_id` = ? WHERE `id` = ?";
...
// ###############################
// # Outputs initialization
copyOfstate_id_updateStruct copyOfstate_id_update_tmp = new copyOfstate_id_updateStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[kRpPItKBiUzfBCYYqumdRutqFyzdT46QoVY9kuBt7d5I+C7L]");
		    ...
		    String dbquery_tMysqlInput_3 = "select b.block_id as 'block_id',b.district_id,b.state_id as 'state_id',p.id as 'panchayat_id' \nfrom dim_block b\njoin di"
+"m_panchayat p on p.block_id = b.block_id";
            ...
            row4.block_id = rs_tMysqlInput_3.getInt(1);
        	...
        	row4.district_id = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 2, false);
		                    }
            ...
            row4.panchayat_id = rs_tMysqlInput_3.getInt(4);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.panchayat_id = null;
            }
		                    }
...
copyOfstate_id_update = null;


// # Output table : 'copyOfstate_id_update'
copyOfstate_id_update_tmp.block_id = row4.block_id ;
copyOfstate_id_update_tmp.district_id = row4.district_id ;
copyOfstate_id_update_tmp.state_id = row4.state_id ;
copyOfstate_id_update_tmp.id = row4.panchayat_id ;
copyOfstate_id_update = copyOfstate_id_update_tmp;
// ###############################
 ...
 */
// Start of branch "copyOfstate_id_update"
if(copyOfstate_id_update != null) { 
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"copyOfstate_id_update");
					}
        ...
        whetherReject_tMysqlOutput_2 = false;
                    if(copyOfstate_id_update.block_id == null) {
pstmt_tMysqlOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(1, copyOfstate_id_update.block_id);
}

                    if(copyOfstate_id_update.district_id == null) {
pstmt_tMysqlOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_2.setString(2, copyOfstate_id_update.district_id);
}

                    if(copyOfstate_id_update.state_id == null) {
pstmt_tMysqlOutput_2.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(3, copyOfstate_id_update.state_id);
}


                    if(copyOfstate_id_update.id == null) {
pstmt_tMysqlOutput_2.setNull(4 + count_tMysqlOutput_2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_2.setInt(4 + count_tMysqlOutput_2, copyOfstate_id_update.id);
}
...
} // End of branch "copyOfstate_id_update"
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_2=nb_line_rejected_tMysqlOutput_2 + rejectedCount_tMysqlOutput_2;
        ...
        globalMap.put("tMysqlOutput_2_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfstate_id_update");
			  	}
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[ZEcBTYP2EPmXpqGwLKmYLu+qWIGi5DoD7TrltVzlv+144J1Z]");
...
query_tMysqlRow_1 = "UPDATE ETL_info_table \nSET \nETL_info_table.last_etl_time = now(),\nETL_info_table.record_count = (SELECT COUNT(*) from d"
+"im_panchayat)\nWHERE \nETL_info_table.table_id = 3";
 ...
 */
    ...
    public static void main(String[] args){
        final Panchayat PanchayatClass = new Panchayat();

        int exitCode = PanchayatClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Panchayat.class.getClassLoader().getResourceAsStream("wash_odf_updated/panchayat_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Panchayat.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Panchayat");
        }
...
/************************************************************************************************
 *     148562 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 December, 2019 1:25:07 PM IST
 ************************************************************************************************/