...
package wash_odf_updated.rejections_daily_etl_0_1;
...
public class Rejections_daily_etl implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Rejections_daily_etl.class.getClassLoader().getResourceAsStream(
					"wash_odf_updated/rejections_daily_etl_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Rejections_daily_etl.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Rejections_daily_etl");
		}
...
/************************************************************************************************
 * 57467 characters generated by Talend Open Studio for Data Integration on the
 * 12 December, 2019 7:47:57 PM IST
 ************************************************************************************************/