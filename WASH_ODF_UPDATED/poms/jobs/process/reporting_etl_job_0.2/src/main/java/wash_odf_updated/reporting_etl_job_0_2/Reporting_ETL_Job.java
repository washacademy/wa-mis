...
package wash_odf_updated.reporting_etl_job_0_2;
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Reporting_ETL_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		wash_odf_updated.dimenison_table_execution_0_1.Dimenison_Table_Execution childJob_tRunJob_1 = new wash_odf_updated.dimenison_table_execution_0_1.Dimenison_Table_Execution();
	    // pass DataSources
...
System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(java.util.Calendar.getInstance().getTime()));
System.out.println("Error occured in Dimension table execution, Refer log printed above");
...
System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(java.util.Calendar.getInstance().getTime()));
System.out.println("Dimension ETL Ended......................");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Reporting_ETL_Job.class.getClassLoader().getResourceAsStream("wash_odf_updated/reporting_etl_job_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Reporting_ETL_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Reporting_ETL_Job");
        }
...
/************************************************************************************************
 *     57360 characters generated by Talend Open Studio for Data Integration 
