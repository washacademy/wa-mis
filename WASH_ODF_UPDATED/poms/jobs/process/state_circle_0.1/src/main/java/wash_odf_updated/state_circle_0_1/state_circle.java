...
package wash_odf_updated.state_circle_0_1;
...
/**
 * Job: state_circle Purpose: To import newly created districts<br>
 * Description: import districts created or modified after last ETL <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class state_circle implements TalendJob {
...
public String getMotech_db_Server(){
	...
	private final String jobName = "state_circle";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(state_circle.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_state_circle = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_state_circle = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_state_circle.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_state_circle.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_state_circle = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_state_circle = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_state_circle, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_state_circle, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_state_circle) {
...
String tableName_tMysqlOutput_1 = "state_circle_rel";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[1QAdw909GdTy6j/FMmmh0tgCwc+kDBATXIFKwJUrwa1Fj8b7]");
...
int count_tMysqlOutput_1=0;
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "state_circle_rel" + "` SET `state_id` = ?,`circle_id` = ? WHERE `id` = ?";
	    ...
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "state_circle_rel" + "` (`id`,`state_id`,`circle_id`) VALUES (?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[mZ44tBIwag6ixPc8o9MwLB/DZTMQnl1nLEASB511GkGKi8R2]");
		    ...
		    String dbquery_tMysqlInput_2 = "select distinct state_id, circle_id from dim_district";
            ...
            row2.state_id = rs_tMysqlInput_2.getInt(1);
            ...
            row2.circle_id = rs_tMysqlInput_2.getInt(2);
            if(rs_tMysqlInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
districts_to_be_updated_tmp.id = 0;
districts_to_be_updated_tmp.state_id = row2.state_id ;
districts_to_be_updated_tmp.circle_id = row2.circle_id ;
	...
	currentComponent="tMysqlOutput_1";
        ...
        whetherReject_tMysqlOutput_1 = false;
            int updateFlag_tMysqlOutput_1=0;
                    pstmtUpdate_tMysqlOutput_1.setInt(1, districts_to_be_updated.state_id);

                    pstmtUpdate_tMysqlOutput_1.setInt(2, districts_to_be_updated.circle_id);


                    pstmtUpdate_tMysqlOutput_1.setInt(3 + count_tMysqlOutput_1, districts_to_be_updated.id);
            ...
            if(updateFlag_tMysqlOutput_1 == 0) {
                        ...
                        pstmtInsert_tMysqlOutput_1.setInt(1, districts_to_be_updated.id);

                        pstmtInsert_tMysqlOutput_1.setInt(2, districts_to_be_updated.state_id);

                        pstmtInsert_tMysqlOutput_1.setInt(3, districts_to_be_updated.circle_id);
 ...
 */
    ...
    public static void main(String[] args){
        final state_circle state_circleClass = new state_circle();

        int exitCode = state_circleClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = state_circle.class.getClassLoader().getResourceAsStream("wash_odf_updated/state_circle_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = state_circle.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : state_circle");
        }
...
/************************************************************************************************
 *     84834 characters generated by Talend Open Studio for Data Integration 
