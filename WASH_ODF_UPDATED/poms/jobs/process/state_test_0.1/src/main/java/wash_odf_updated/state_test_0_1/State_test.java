...
package wash_odf_updated.state_test_0_1;
...
/**
 * Job: State_test Purpose: ETL for states<br>
 * Description: move states from motech_data_services to new database <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status DEV
 */
public class State_test implements TalendJob {
...
public String getMotech_db_Server(){
	...
	private final String jobName = "State_test";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(State_test.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_State_test = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_State_test = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_State_test.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_State_test.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_State_test = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_State_test = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_State_test, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_State_test, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_State_test) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[c3rIOV6Rn54/PqfHGuIVUoz3nLQXDZdqMtRL0SUqVF/j5pm5]");
...
String tableName_tMysqlOutput_1 = "dim_state";
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[VgL07QkF5vt3pjrUGXPmVjQZnVGjj35sgvl3eAdhTUZFbPbt]");
...
int count_tMysqlOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "dim_state" + "` WHERE `loc_id` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_1", pstmt_tMysqlOutput_1);
	    String insert_tMysqlOutput_1 = "INSERT INTO `" + "dim_state" + "` (`loc_id`,`state_name`,`last_modified`) VALUES (?,?,?)";
	    ...
	    String update_tMysqlOutput_1 = "UPDATE `" + "dim_state" + "` SET `state_name` = ?,`last_modified` = ? WHERE `loc_id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[ifbRHbp5xaapu87b+nsqQEt0TR314yE2we3nuDhCsMotXQ35]");
...
// # Output table : 'output'
output_tmp.loc_id = row1.id ;
output_tmp.state_name = row1.name ;
	...
	currentComponent="tMysqlOutput_1";
        ...
        whetherReject_tMysqlOutput_1 = false;
            ...
            if(checkCount_tMysqlOutput_1 > 0) {
                        if(output.state_name == null) {
pstmtUpdate_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_1.setString(1, output.state_name);
}
...
pstmtUpdate_tMysqlOutput_1.setString(2, "0000-00-00 00:00:00");
} else {pstmtUpdate_tMysqlOutput_1.setTimestamp(2, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmtUpdate_tMysqlOutput_1.setNull(2, java.sql.Types.DATE);
}

                        pstmtUpdate_tMysqlOutput_1.setLong(3 + count_tMysqlOutput_1, output.loc_id);
...
} else {pstmtInsert_tMysqlOutput_1.setString(2, output.state_name);
}

                        if(output.last_modified != null) {
date_tMysqlOutput_1 = output.last_modified.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmtInsert_tMysqlOutput_1.setString(3, "0000-00-00 00:00:00");
} else {pstmtInsert_tMysqlOutput_1.setTimestamp(3, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmtInsert_tMysqlOutput_1.setNull(3, java.sql.Types.DATE);
}
...
String tableName_tMysqlOutput_2 = "dim_state";
...
java.sql.Connection conn_tMysqlOutput_2 = null;
	...
	final String decryptedPassword_tMysqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[W9oCv/TgPDfoys4ErczSAZKdbz2bQrHOOjKGU9cn25aNDQWG]");
...
int count_tMysqlOutput_2=0;
	    ...
	    String update_tMysqlOutput_2 = "UPDATE `" + "dim_state" + "` SET `code` = ? WHERE `loc_id` = ?";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[snFTftCn4cNsi4cvp4CTG4nyWuvneF7nsTgJ1YqYgbOY8cqH]");
		    ...
		    String dbquery_tMysqlInput_3 = "select id, code\nfrom wash_states";
            ...
            row4.code = rs_tMysqlInput_3.getLong(2);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.code = null;
            }
		                    }
...
stateCode_tmp.loc_id = row4.id ;
stateCode_tmp.code = row4.code ;
...
} else {pstmt_tMysqlOutput_2.setLong(1, stateCode.code);
}


                    pstmt_tMysqlOutput_2.setLong(2 + count_tMysqlOutput_2, stateCode.loc_id);
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[KmEaYLKCUt7fnErDR9mcXlKYCBsIURPHH9UY5DZ69/FOj95E]");
...
query_tMysqlRow_1 = "UPDATE ETL_info_table \nSET \nETL_info_table.last_etl_time = (SELECT MAX(last_modified) from dim_state),\nETL_info_table.r"
+"ecord_count = (SELECT COUNT(*) from dim_state)\nWHERE \nETL_info_table.table_id = 1";
 ...
 */
    ...
    public static void main(String[] args){
        final State_test State_testClass = new State_test();

        int exitCode = State_testClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = State_test.class.getClassLoader().getResourceAsStream("wash_odf_updated/state_test_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = State_test.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : State_test");
        }
...
/************************************************************************************************
 *     134637 characters generated by Talend Open Studio for Data Integration 
