...
package wash_odf_updated.wa_call_content_0_1;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_WA_Call_Content = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_WA_Call_Content = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_WA_Call_Content.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_WA_Call_Content.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_WA_Call_Content = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_WA_Call_Content = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_WA_Call_Content, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_WA_Call_Content, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_WA_Call_Content) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[QwKmtR7p+wuhm82pJVU34VNRONc5nOpEv0CYPaGXOttSxQrN]");
...
java.sql.Connection conn_tMysqlOutput_1 = null;
	...
	final String decryptedPassword_tMysqlOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[sNsmVZJZc+PYnuYbZVX1nQwdafjR+jB6e31XaP2XKntvn96g]");
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[vdplYeB5FWTFPKQEhRPB7T+NZ0FE7h2WjLs8bX2KQEzb8HBV]");
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[ncqeKYg12K3WNoldAaU3HJBAKVRVtgd1t+JZY7eqMyGi1FXw]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = WA_Call_Content.class.getClassLoader().getResourceAsStream("wash_odf_updated/wa_call_content_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     110062 characters generated by Talend Open Studio for Data Integration 
