...
package wash_odf_updated.wa_circle_wise_anonymous_users_0_1;
...
/**
 * Job: WA_Circle_wise_Anonymous_Users Purpose: WA_Circle_wise_Anonymous_Users<br>
 * Description: WA_Circle_wise_Anonymous_Users <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class WA_Circle_wise_Anonymous_Users implements TalendJob {
...
public String getMotech_db_Server(){
	...
	private final String jobName = "WA_Circle_wise_Anonymous_Users";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				WA_Circle_wise_Anonymous_Users.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(WA_Circle_wise_Anonymous_Users.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users.length) {
				if(length < 1024 && commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users.length == 0) {
   					commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users = new byte[1024];
				} else {
   					commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users, 0, length);
			strReturn = new String(commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users) {
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[1TJOXqNLIdu0ckfCDFF/A6vd6K0YYKUpzpAORa2kdTQ0T57a]");
...
public static class copyOfMa_course_completion_dataStruct implements routines.system.IPersistableRow<copyOfMa_course_completion_dataStruct> {
    final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users = new byte[0];
    static byte[] commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String last_call_end_date;

				public String getLast_call_end_date () {
					return this.last_call_end_date;
				}
				
			    public String last_call_end_time;

				public String getLast_call_end_time () {
					return this.last_call_end_time;
				}
				
			    public Long no_of_attempts;

				public Long getNo_of_attempts () {
					return this.no_of_attempts;
				}
				
			    public String SMS_reference_no;

				public String getSMS_reference_no () {
					return this.SMS_reference_no;
				}
			    ...
			    public String first_completion_date;

				public String getFirst_completion_date () {
					return this.first_completion_date;
				}
			    ...
			    public String total_minutes_used;

				public String getTotal_minutes_used () {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.mobile_number;
	...
	public boolean equals(Object obj) {
		...
		final copyOfMa_course_completion_dataStruct other = (copyOfMa_course_completion_dataStruct) obj;
		
						if (this.id != other.id)
							return false;
					
						if (this.mobile_number != other.mobile_number)
							return false;
	...
	public void copyDataTo(copyOfMa_course_completion_dataStruct other) {

		other.circle_name = this.circle_name;
	            other.id = this.id;
	            other.mobile_number = this.mobile_number;
	            other.last_call_end_date = this.last_call_end_date;
	            other.last_call_end_time = this.last_call_end_time;
	            other.no_of_attempts = this.no_of_attempts;
	            other.SMS_reference_no = this.SMS_reference_no;
	            other.SMS_sent = this.SMS_sent;
	            other.course_start_date = this.course_start_date;
	            other.first_completion_date = this.first_completion_date;
	            other.operator = this.operator;
	            other.total_minutes_used = this.total_minutes_used;
	            other.courseId = this.courseId;
	            
	}

	public void copyKeysDataTo(copyOfMa_course_completion_dataStruct other) {
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.last_call_end_date = readString(dis);
					
					this.last_call_end_time = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.no_of_attempts = null;
           				} else {
           			    	this.no_of_attempts = dis.readLong();
           				}
					
					this.SMS_reference_no = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.SMS_sent = null;
           				} else {
           			    	this.SMS_sent = dis.readBoolean();
           				}
					
					this.course_start_date = readString(dis);
					
					this.first_completion_date = readString(dis);
					
					this.operator = readString(dis);
					
					this.total_minutes_used = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.last_call_end_date,dos);
					
					// String
				
						writeString(this.last_call_end_time,dos);
					
					// Long
				
						if(this.no_of_attempts == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.no_of_attempts);
		            	}
					
					// String
				
						writeString(this.SMS_reference_no,dos);
					
					// Boolean
				
						if(this.SMS_sent == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeBoolean(this.SMS_sent);
		            	}
					
					// String
				
						writeString(this.course_start_date,dos);
					
					// String
				
						writeString(this.first_completion_date,dos);
					...
					// String
						...
						writeString(this.total_minutes_used,dos);
    ...
    public String toString() {
		...
		sb.append(",last_call_end_date="+last_call_end_date);
		sb.append(",last_call_end_time="+last_call_end_time);
		sb.append(",no_of_attempts="+String.valueOf(no_of_attempts));
		sb.append(",SMS_reference_no="+SMS_reference_no);
		sb.append(",SMS_sent="+String.valueOf(SMS_sent));
		sb.append(",course_start_date="+course_start_date);
		sb.append(",first_completion_date="+first_completion_date);
		sb.append(",operator="+operator);
		sb.append(",total_minutes_used="+total_minutes_used);
     ...
     * Compare keys
     */
    public int compareTo(copyOfMa_course_completion_dataStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.mobile_number, other.mobile_number);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    ...
    static byte[] commonByteArray_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users = new byte[0];
			    ...
			    public String first_completion;

				public String getFirst_completion () {
					return this.first_completion;
				}
				
			    public Long num_of_attempts;

				public Long getNum_of_attempts () {
					return this.num_of_attempts;
				}
		...
		synchronized(commonByteArrayLock_WASH_ODF_UPDATED_WA_Circle_wise_Anonymous_Users) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.first_completion = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.num_of_attempts = null;
           				} else {
           			    	this.num_of_attempts = dis.readLong();
           				}
					...
					this.last_call_date = readString(dis);
					
					this.last_call_time = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.first_completion,dos);
					
					// Long
				
						if(this.num_of_attempts == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeLong(this.num_of_attempts);
		            	}
					...
					// String
						...
						writeString(this.last_call_date,dos);
					
					// String
				
						writeString(this.last_call_time,dos);
    ...
    public String toString() {
		...
		sb.append(",first_completion="+first_completion);
		sb.append(",num_of_attempts="+String.valueOf(num_of_attempts));
		sb.append(",duration="+duration);
		sb.append(",sent_notification="+String.valueOf(sent_notification));
		sb.append(",operator="+operator);
		sb.append(",last_call_date="+last_call_date);
		sb.append(",last_call_time="+last_call_time);
		sb.append(",course_start_date="+course_start_date);
		sb.append(",courseId="+String.valueOf(courseId));
	    sb.append("]");
...
copyOfMa_course_completion_dataStruct copyOfMa_course_completion_data = new copyOfMa_course_completion_dataStruct();
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfMa_course_completion_data");
					}
        ...
        int updateKeyCount_tMysqlOutput_2 = 2;
...
String tableName_tMysqlOutput_2 = "WA_circle_wise_anonymous_line_listing";
...
java.sql.Connection conn_tMysqlOutput_2 = null;
	...
	final String decryptedPassword_tMysqlOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[HIyrU4cfvkqBfPwTIjsBBrRCph0XDVls7IkeuKTe61jDTsrf]");
...
int count_tMysqlOutput_2=0;
	    ...
	    java.sql.PreparedStatement pstmt_tMysqlOutput_2 = conn_tMysqlOutput_2.prepareStatement("SELECT COUNT(1) FROM `" + "WA_circle_wise_anonymous_line_listing" + "` WHERE `id` = ? AND `mobile_number` = ?");
	    resourceMap.put("pstmt_tMysqlOutput_2", pstmt_tMysqlOutput_2);
	    String insert_tMysqlOutput_2 = "INSERT INTO `" + "WA_circle_wise_anonymous_line_listing" + "` (`circle_name`,`id`,`mobile_number`,`last_call_end_date`,`last_call_end_time`,`no_of_attempts`,`SMS_reference_no`,`SMS_sent`,`course_start_date`,`first_completion_date`,`operator`,`total_minutes_used`,`courseId`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
	        
	    java.sql.PreparedStatement pstmtInsert_tMysqlOutput_2 = conn_tMysqlOutput_2.prepareStatement(insert_tMysqlOutput_2);
	    resourceMap.put("pstmtInsert_tMysqlOutput_2", pstmtInsert_tMysqlOutput_2);
	    String update_tMysqlOutput_2 = "UPDATE `" + "WA_circle_wise_anonymous_line_listing" + "` SET `circle_name` = ?,`last_call_end_date` = ?,`last_call_end_time` = ?,`no_of_attempts` = ?,`SMS_reference_no` = ?,`SMS_sent` = ?,`course_start_date` = ?,`first_completion_date` = ?,`operator` = ?,`total_minutes_used` = ?,`courseId` = ? WHERE `id` = ? AND `mobile_number` = ?";
	    
	    java.sql.PreparedStatement pstmtUpdate_tMysqlOutput_2 = conn_tMysqlOutput_2.prepareStatement(update_tMysqlOutput_2);
...
copyOfMa_course_completion_dataStruct copyOfMa_course_completion_data_tmp = new copyOfMa_course_completion_dataStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[jK2u9bNEDHQR3Oo9dpUMA2bQsJ30qyz1HLwN4R+5HpspbdLB]");
		    ...
		    String dbquery_tMysqlInput_3 = "select distinct a.mobile_number,a.circle_name,a.smsReferenceNumber,\na.first_completion,b.num_of_attempts,c.duration,\na."
+"sent_notification,d.operator,a.last_call_date,a.last_call_time,a.course_start_date,a.courseId\n\nfrom (select cdrs.circle "
+"as 'circle_name',cdrs.callingNumber as 'mobile_number',\nccf.first_completion,\nccf.sent_notification,\nwccr.smsReferenceNu"
+"mber,\nDate(max(cdrs.callEndTime)) as 'last_call_date', \nmax(cdrs.callEndTime) as 'last_call_time',\nmin(cdrs.callStartTim"
+"e) as 'course_start_date',\ncdrs.courseId\nfrom wash_swachgrahi_cdrs cdrs \nLEFT join wash_swachchagrahi s on s.id = cdrs.s"
+"wachchagrahi_id_OID\njoin wash_circles c on cdrs.circle = c.name\nleft join WAReporting.WA_course_completion_first ccf on "
+"ccf.mobile_number = cdrs.callingNumber and ccf.courseId = cdrs.courseId\nleft join wash_course_completion_records wccr on"
+" wccr.creationDate = ccf.first_completion and wccr.courseId = ccf.courseId\nwhere s.courseStatus = 'ANONYMOUS' \nand cdrs."
+"modificationDate >'"+(String)globalMap.get("lastEtlTime")+"'\ngroup by cdrs.callingNumber,cdrs.circle,ccf.first_completion,\nccf.sent_notification,wccr.smsReferenceNumber,\ncdrs.cal"
+"lingNumber,cdrs.courseId\norder by cdrs.callingNumber) as a\n\nleft join \n(SELECT callingNumber as 'mobile_number',count(*)"
+" as 'num_of_attempts', courseId\nFROM motech_data_services.wash_swachgrahi_cdrs group by mobile_number, courseId\n) as b o"
+"n a.mobile_number = b.mobile_number and a.courseId = b.courseId\n\nleft join\n(SELECT mobile_number,sum(duration)/60 as 'du"
+"ration' , courseId\n FROM WAReporting.WA_call_detail_measure group by mobile_number, courseId) as c \n on c.mobile_number="
+" a.mobile_number and c.courseId = a.courseId\n \nleft join \n(select callingNumber as 'mobile_number', operator,callEndTime"
+", courseId \nfrom motech_data_services.wash_swachgrahi_cdrs) as d \non d.mobile_number = a.mobile_number and d.callEndTime"
+" = a.last_call_time and d.courseId = a.courseId"
;
		    ...
		    while (rs_tMysqlInput_3.next()) {
		        nb_line_tMysqlInput_3++;
							...
							if(colQtyInRs_tMysqlInput_3 < 1) {
								row4.mobile_number = 0;
							} else {
		                          
            row4.mobile_number = rs_tMysqlInput_3.getLong(1);
            if(rs_tMysqlInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_3 < 2) {
								row4.circle_name = null;
							} else {
	                         		
        	row4.circle_name = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 2, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 3) {
								row4.smsReferenceNumber = null;
							} else {
	                         		
        	row4.smsReferenceNumber = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 3, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 4) {
								row4.first_completion = null;
							} else {
	                         		
        	row4.first_completion = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 4, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 5) {
								row4.num_of_attempts = null;
							} else {
		                          
            row4.num_of_attempts = rs_tMysqlInput_3.getLong(5);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.num_of_attempts = null;
            }
		                    }
        	...
        	row4.duration = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 6, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 7) {
								row4.sent_notification = null;
							} else {
	                         		
            row4.sent_notification = rs_tMysqlInput_3.getBoolean(7);
            if(rs_tMysqlInput_3.wasNull()){
                    row4.sent_notification = null;
            }
		                    }
        	...
        	row4.operator = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 8, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 9) {
								row4.last_call_date = null;
							} else {
	                         		
        	row4.last_call_date = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 9, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 10) {
								row4.last_call_time = null;
							} else {
	                         		
        	row4.last_call_time = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 10, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 11) {
								row4.course_start_date = null;
							} else {
	                         		
        	row4.course_start_date = routines.system.JDBCUtil.getString(rs_tMysqlInput_3, 11, false);
		                    }
							if(colQtyInRs_tMysqlInput_3 < 12) {
								row4.courseId = 0;
							} else {
		                          
            row4.courseId = rs_tMysqlInput_3.getInt(12);
            if(rs_tMysqlInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
copyOfMa_course_completion_data = null;


// # Output table : 'copyOfMa_course_completion_data'
copyOfMa_course_completion_data_tmp.circle_name = row4.circle_name ;
copyOfMa_course_completion_data_tmp.id = 0;
copyOfMa_course_completion_data_tmp.mobile_number = row4.mobile_number ;
copyOfMa_course_completion_data_tmp.last_call_end_date = row4.last_call_date ;
copyOfMa_course_completion_data_tmp.last_call_end_time = row4.last_call_time ;
copyOfMa_course_completion_data_tmp.no_of_attempts = row4.num_of_attempts ;
copyOfMa_course_completion_data_tmp.SMS_reference_no = row4.smsReferenceNumber ;
copyOfMa_course_completion_data_tmp.SMS_sent = row4.sent_notification ;
copyOfMa_course_completion_data_tmp.course_start_date = row4.course_start_date ;
copyOfMa_course_completion_data_tmp.first_completion_date = row4.first_completion ;
copyOfMa_course_completion_data_tmp.operator = row4.operator ;
copyOfMa_course_completion_data_tmp.total_minutes_used = row4.duration ;
copyOfMa_course_completion_data_tmp.courseId = row4.courseId;
copyOfMa_course_completion_data = copyOfMa_course_completion_data_tmp;
// ###############################
 ...
 */
// Start of branch "copyOfMa_course_completion_data"
if(copyOfMa_course_completion_data != null) { 
	...
	currentComponent="tMysqlOutput_2";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"copyOfMa_course_completion_data");
					}
        ...
        whetherReject_tMysqlOutput_2 = false;
                    pstmt_tMysqlOutput_2.setLong(1, copyOfMa_course_completion_data.id);

                    pstmt_tMysqlOutput_2.setLong(2, copyOfMa_course_completion_data.mobile_number);
            ...
            if(checkCount_tMysqlOutput_2 > 0) {
                        if(copyOfMa_course_completion_data.circle_name == null) {
pstmtUpdate_tMysqlOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(1, copyOfMa_course_completion_data.circle_name);
}

                        if(copyOfMa_course_completion_data.last_call_end_date == null) {
pstmtUpdate_tMysqlOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(2, copyOfMa_course_completion_data.last_call_end_date);
}

                        if(copyOfMa_course_completion_data.last_call_end_time == null) {
pstmtUpdate_tMysqlOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(3, copyOfMa_course_completion_data.last_call_end_time);
}

                        if(copyOfMa_course_completion_data.no_of_attempts == null) {
pstmtUpdate_tMysqlOutput_2.setNull(4, java.sql.Types.INTEGER);
} else {pstmtUpdate_tMysqlOutput_2.setLong(4, copyOfMa_course_completion_data.no_of_attempts);
}

                        if(copyOfMa_course_completion_data.SMS_reference_no == null) {
pstmtUpdate_tMysqlOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(5, copyOfMa_course_completion_data.SMS_reference_no);
}

                        if(copyOfMa_course_completion_data.SMS_sent == null) {
pstmtUpdate_tMysqlOutput_2.setNull(6, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tMysqlOutput_2.setBoolean(6, copyOfMa_course_completion_data.SMS_sent);
}

                        if(copyOfMa_course_completion_data.course_start_date == null) {
pstmtUpdate_tMysqlOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(7, copyOfMa_course_completion_data.course_start_date);
}

                        if(copyOfMa_course_completion_data.first_completion_date == null) {
pstmtUpdate_tMysqlOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(8, copyOfMa_course_completion_data.first_completion_date);
}

                        if(copyOfMa_course_completion_data.operator == null) {
pstmtUpdate_tMysqlOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(9, copyOfMa_course_completion_data.operator);
}

                        if(copyOfMa_course_completion_data.total_minutes_used == null) {
pstmtUpdate_tMysqlOutput_2.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tMysqlOutput_2.setString(10, copyOfMa_course_completion_data.total_minutes_used);
}

                        pstmtUpdate_tMysqlOutput_2.setInt(11, copyOfMa_course_completion_data.courseId);

                        pstmtUpdate_tMysqlOutput_2.setLong(12 + count_tMysqlOutput_2, copyOfMa_course_completion_data.id);

                        pstmtUpdate_tMysqlOutput_2.setLong(13 + count_tMysqlOutput_2, copyOfMa_course_completion_data.mobile_number);

                try {
                    updatedCount_tMysqlOutput_2 = updatedCount_tMysqlOutput_2 + pstmtUpdate_tMysqlOutput_2.executeUpdate();
                    ...
                    whetherReject_tMysqlOutput_2 = true;
                        ...
                        if(copyOfMa_course_completion_data.circle_name == null) {
pstmtInsert_tMysqlOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(1, copyOfMa_course_completion_data.circle_name);
}

                        pstmtInsert_tMysqlOutput_2.setLong(2, copyOfMa_course_completion_data.id);

                        pstmtInsert_tMysqlOutput_2.setLong(3, copyOfMa_course_completion_data.mobile_number);

                        if(copyOfMa_course_completion_data.last_call_end_date == null) {
pstmtInsert_tMysqlOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(4, copyOfMa_course_completion_data.last_call_end_date);
}

                        if(copyOfMa_course_completion_data.last_call_end_time == null) {
pstmtInsert_tMysqlOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(5, copyOfMa_course_completion_data.last_call_end_time);
}

                        if(copyOfMa_course_completion_data.no_of_attempts == null) {
pstmtInsert_tMysqlOutput_2.setNull(6, java.sql.Types.INTEGER);
} else {pstmtInsert_tMysqlOutput_2.setLong(6, copyOfMa_course_completion_data.no_of_attempts);
}

                        if(copyOfMa_course_completion_data.SMS_reference_no == null) {
pstmtInsert_tMysqlOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(7, copyOfMa_course_completion_data.SMS_reference_no);
}

                        if(copyOfMa_course_completion_data.SMS_sent == null) {
pstmtInsert_tMysqlOutput_2.setNull(8, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tMysqlOutput_2.setBoolean(8, copyOfMa_course_completion_data.SMS_sent);
}

                        if(copyOfMa_course_completion_data.course_start_date == null) {
pstmtInsert_tMysqlOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(9, copyOfMa_course_completion_data.course_start_date);
}

                        if(copyOfMa_course_completion_data.first_completion_date == null) {
pstmtInsert_tMysqlOutput_2.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(10, copyOfMa_course_completion_data.first_completion_date);
}

                        if(copyOfMa_course_completion_data.operator == null) {
pstmtInsert_tMysqlOutput_2.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(11, copyOfMa_course_completion_data.operator);
}

                        if(copyOfMa_course_completion_data.total_minutes_used == null) {
pstmtInsert_tMysqlOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtInsert_tMysqlOutput_2.setString(12, copyOfMa_course_completion_data.total_minutes_used);
}

                        pstmtInsert_tMysqlOutput_2.setInt(13, copyOfMa_course_completion_data.courseId);

                try {
                    insertedCount_tMysqlOutput_2 = insertedCount_tMysqlOutput_2 + pstmtInsert_tMysqlOutput_2.executeUpdate();
                    nb_line_tMysqlOutput_2++;
                } catch(java.lang.Exception e) {
                    whetherReject_tMysqlOutput_2 = true;
                        nb_line_tMysqlOutput_2++;
...
} // End of branch "copyOfMa_course_completion_data"
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_2=nb_line_rejected_tMysqlOutput_2 + rejectedCount_tMysqlOutput_2;
        ...
        globalMap.put("tMysqlOutput_2_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfMa_course_completion_data");
			  	}
 ...
 */
    ...
    if (resourceMap.get("statementClosed_tMysqlOutput_2") == null) {
                ...
                if ((pstmtUpdateToClose_tMysqlOutput_2 = (java.sql.PreparedStatement) resourceMap.remove("pstmtUpdate_tMysqlOutput_2")) != null) {
                    pstmtUpdateToClose_tMysqlOutput_2.close();
                }
                java.sql.PreparedStatement pstmtInsertToClose_tMysqlOutput_2 = null;
                if ((pstmtInsertToClose_tMysqlOutput_2 = (java.sql.PreparedStatement) resourceMap.remove("pstmtInsert_tMysqlOutput_2")) != null) {
...
public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[tA5h9vFIrkYbVuwHEpXIy3zYL4AH4Wp+28gWwzyljZRMCxxC]");
...
query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT MAX(last_call_end_time)FROM \n WA_circle_wise_anonymous"
+"_line_listing),\nETL_info_table.record_count=(select count(*) from WA_circle_wise_anonymous_line_listing)\nWHERE ETL_info_"
+"table.table_id = 17";
 ...
 */
    ...
    public static void main(String[] args){
        final WA_Circle_wise_Anonymous_Users WA_Circle_wise_Anonymous_UsersClass = new WA_Circle_wise_Anonymous_Users();

        int exitCode = WA_Circle_wise_Anonymous_UsersClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = WA_Circle_wise_Anonymous_Users.class.getClassLoader().getResourceAsStream("wash_odf_updated/wa_circle_wise_anonymous_users_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = WA_Circle_wise_Anonymous_Users.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : WA_Circle_wise_Anonymous_Users");
        }
...
/************************************************************************************************
 *     115470 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 December, 2019 1:25:10 PM IST
 ************************************************************************************************/