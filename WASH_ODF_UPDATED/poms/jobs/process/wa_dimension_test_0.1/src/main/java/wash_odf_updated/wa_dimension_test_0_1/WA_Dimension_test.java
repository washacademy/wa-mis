...
package wash_odf_updated.wa_dimension_test_0_1;
...
/**
 * Job: WA_Dimension_test Purpose: WA_Dimension<br>
 * Description: WA_Dimension <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class WA_Dimension_test implements TalendJob {
	...
	private final String jobName = "WA_Dimension_test";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					WA_Dimension_test.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WA_Dimension_test.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_WASH_ODF_UPDATED_WA_Dimension_test = new byte[0];
		static byte[] commonByteArray_WASH_ODF_UPDATED_WA_Dimension_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_WASH_ODF_UPDATED_WA_Dimension_test.length) {
					if (length < 1024 && commonByteArray_WASH_ODF_UPDATED_WA_Dimension_test.length == 0) {
						commonByteArray_WASH_ODF_UPDATED_WA_Dimension_test = new byte[1024];
					} else {
						commonByteArray_WASH_ODF_UPDATED_WA_Dimension_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_WASH_ODF_UPDATED_WA_Dimension_test, 0, length);
				strReturn = new String(commonByteArray_WASH_ODF_UPDATED_WA_Dimension_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_WASH_ODF_UPDATED_WA_Dimension_test) {
...
// Start of branch "row1"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String driverClass_tMysqlRow_1 = "com.mysql.cj.jdbc.Driver";
				...
				final String decryptedPassword_tMysqlRow_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[8HQ3nrtEngLJ6j7setdVTRi5on+68stiWl4vjVQO1har5GLn]");
	...
	public static void main(String[] args) {
		final WA_Dimension_test WA_Dimension_testClass = new WA_Dimension_test();

		int exitCode = WA_Dimension_testClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = WA_Dimension_test.class.getClassLoader().getResourceAsStream(
					"wash_odf_updated/wa_dimension_test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WA_Dimension_test.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : WA_Dimension_test");
		}
...
/************************************************************************************************
 * 59405 characters generated by Talend Open Studio for Data Integration on the
 * 12 December, 2019 1:08:29 PM IST
 ************************************************************************************************/