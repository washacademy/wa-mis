...
package wash_odf_updated.wa_mk_data_0_2;
...
/**
 * Job: WA_MK_Data Purpose: WA_MK_Data<br>
 * Description: WA_MK_Data <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class WA_MK_Data implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "WA_MK_Data";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(WA_MK_Data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		wash_odf_updated.swachchagrahi_test_0_1.Swachchagrahi_test childJob_tRunJob_2 = new wash_odf_updated.swachchagrahi_test_0_1.Swachchagrahi_test();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		wash_odf_updated.wa_call_details_0_1.WA_call_details childJob_tRunJob_1 = new wash_odf_updated.wa_call_details_0_1.WA_call_details();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		wash_odf_updated.wa_call_content_0_1.WA_Call_Content childJob_tRunJob_4 = new wash_odf_updated.wa_call_content_0_1.WA_Call_Content();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		wash_odf_updated.wa_course_completion_0_1.WA_Course_Completion childJob_tRunJob_7 = new wash_odf_updated.wa_course_completion_0_1.WA_Course_Completion();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		wash_odf_updated.wa_course_completion_cummulative_0_1.WA_Course_Completion_Cummulative childJob_tRunJob_3 = new wash_odf_updated.wa_course_completion_cummulative_0_1.WA_Course_Completion_Cummulative();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		wash_odf_updated.wa_circle_wise_anonymous_users_0_1.WA_Circle_wise_Anonymous_Users childJob_tRunJob_5 = new wash_odf_updated.wa_circle_wise_anonymous_users_0_1.WA_Circle_wise_Anonymous_Users();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final WA_MK_Data WA_MK_DataClass = new WA_MK_Data();

        int exitCode = WA_MK_DataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = WA_MK_Data.class.getClassLoader().getResourceAsStream("wash_odf_updated/wa_mk_data_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = WA_MK_Data.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : WA_MK_Data");
        }
...
/************************************************************************************************
 *     61135 characters generated by Talend Open Studio for Data Integration 
