...
package wash_odf_updated.wa_mk_etl_job_0_3;
...
/**
 * Job: WA_MK_ETL_JOB Purpose: WA_MK_ETL_JOB<br>
 * Description: WA_MK_ETL_JOB <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class WA_MK_ETL_JOB implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "WA_MK_ETL_JOB";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				WA_MK_ETL_JOB.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(WA_MK_ETL_JOB.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_1 = new wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		wash_odf_updated.wa_mk_data_0_2.WA_MK_Data childJob_tRunJob_2 = new wash_odf_updated.wa_mk_data_0_2.WA_MK_Data();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test childJob_tRunJob_3 = new wash_odf_updated.log_etl_table_info_test_0_1.Log_Etl_Table_Info_test();
	    // pass DataSources
...
System.out.println(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(java.util.Calendar.getInstance().getTime()));
System.out.println("Error occured in MA/MK ETL execution, Please Refer log printed above");
 ...
 */
    ...
    public static void main(String[] args){
        final WA_MK_ETL_JOB WA_MK_ETL_JOBClass = new WA_MK_ETL_JOB();

        int exitCode = WA_MK_ETL_JOBClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = WA_MK_ETL_JOB.class.getClassLoader().getResourceAsStream("wash_odf_updated/wa_mk_etl_job_0_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = WA_MK_ETL_JOB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : WA_MK_ETL_JOB");
        }
...
/************************************************************************************************
 *     57264 characters generated by Talend Open Studio for Data Integration 
