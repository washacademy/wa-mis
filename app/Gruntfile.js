  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      dist1: {
        ...
        'scripts/controllers/createUser.js','scripts/controllers/downloads.js','scripts/controllers/editUser.js',
        'scripts/controllers/forgotPassword.js', 'scripts/controllers/profile.js',
        'scripts/controllers/userManagement.js','scripts/controllers/userManual.js', 'scripts/directives/pagination.js','scripts/controllers/userTable.js'],
        dest: 'dist/app1.js'
      },
      dist2: {
