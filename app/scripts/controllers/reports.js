...
//             }
            ...
            $scope.WA_Cumulative_Column_Definitions =[
                                                       ...
                                                       { field: 'swachchagrahisRegistered', displayName : 'No of Registered Users', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
                                                       { field: 'swachchagrahisStarted', displayName : 'No of Users Started course',  aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
                                                       { field: 'swachchagrahisNotStarted', displayName : 'No of Users Not Started course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
                                                       { field: 'swachchagrahisCompleted' , displayName : 'No of Users Successfully Completed the course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"13%", enableHiding: false},
                                                       { field: 'swachchagrahisFailed' , displayName : 'No of Users who failed the course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
            ...
            $scope.WA_Performance_Column_Definitions =[
                                                         ...
                                                         { field: 'swachchagrahisStartedCourse', displayName: 'No. of Users Started course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*",enableHiding: false },
                                                         { field: 'swachchagrahisPursuingCourse', displayName: 'No. of Users Pursuing course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false },
                                                         { field: 'swachchagrahisNotPursuingCourse', displayName: 'No. of Users not Pursuing course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
                                                         { field: 'swachchagrahisCompletedCourse', displayName: 'No. of Users Successfully Completed course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"18%",enableHiding: false},
                                                         { field: 'swachchagrahisFailedCourse',  displayName: 'No. of Users who Failed the course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
                                                        ],
            ...
            $scope.WA_Subscriber_Column_Definitions =[
                                                         ...
                                                         { field: 'swachchagrahisRegistered', displayName: 'No. of Users Subscriptions Added', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
                                                         { field: 'swachchagrahisCompleted',  displayName: 'No. of Users Successfully Completed the course', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false},
